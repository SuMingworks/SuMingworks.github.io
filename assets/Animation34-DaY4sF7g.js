import{a as e}from"./lil-gui.esm-jlbWO7FJ.js";import{Dr as t,Dt as n,Et as r,Gt as i,Un as a,Vt as o,Xn as s,Y as c,Zn as l,l as u,r as d,u as f,vt as p}from"./three.module-TVF63cYk.js";import{i as m,n as h,r as g,t as _}from"./OutputPass-CxDAHfy4.js";import{t as v}from"./UnrealBloomPass-C17ZlHgr.js";import{i as y,n as b,r as x,t as S}from"./GUIHelper-DspWBXk2.js";import{t as C}from"./OrbitControls-Ju8LL-qO.js";import{t as w}from"./AfterimagePass-BNHDFdEI.js";import{t as T}from"./GPUComputationRenderer-CvcRq-4M.js";var E=(e=!1)=>({blending:5,blendEquation:100,blendSrc:e?201:204,blendDst:201,blendEquationAlpha:100,blendSrcAlpha:200,blendDstAlpha:201,premultipliedAlpha:e}),D=e=>{e.compFsMaterial.fragmentShader=`
    uniform float damp;
  ...
  `,e.compFsMaterial.needsUpdate=!0},O=class{constructor(e,t={}){this.canvas=e;let n={particleSize:.3,particleGridSize:100,particleEnergyAmplification:0,particleAudioScatter:.05,particleAudio:1,particleContainment:.004,particleRotationSpeed:0,hueSpeed:.04,hueRadiusScale:.2,hueAngleScale:.15,hueAudioShift:.8,hueBrightnessScale:.3,particleBrightness:1,diskSpeed:.05,diskPulse:.03,diskKickPulse:.1,diskVariationSpeed:.02,diskHueOffset:.1,diskSaturation:1,diskHueAudioShift:.8,coreSize:.3,corePulse:.6,coreBeatPulse:.5,shellEnergyGlow:.15,bloomStrength:1.5,bloomThreshold:.9,bloomRadius:.1,bloomEnergyAmplification:.5,bloomBeatBurst:1,chromaticAmount:.0015,chromaAudio:1,afterimageDamp:.82,exposure:1.2,exposureAudio:1,audioIntensity:1,cameraPosition:{x:8,y:-20,z:8}};this.settings={...n,...t},this.defaultSettings=n,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.previousCanvasMixBlendMode=this.canvas.style.mixBlendMode,this.gpuCompute=null,this.positionVariable=null,this.velocityVariable=null,this.particleMesh=null,this.particleMaterial=null,this.core=null,this.coreShell=null,this.disk=null,this.bloomPass=null,this.afterimagePass=null,this.chromaPass=null,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this.lastTime=0,this._time=0,this._elapsed=0,this.bass=0,this.mid=0,this.high=0,this.energy=0,this.kick=0,this.snare=0,this.motion=0,this.brightness=0,this.variation=0,this.downbeat=0,this.hasAudioData=!1,this.init().then(()=>{}).catch(e=>{console.error(`❌ Animation34 初始化失败:`,e)})}async init(){try{return this.setupThreeJS(),this.setupComposer(),this.initGPUCompute(),this.initParticles(),this.syncParticleUniforms(),this.initCoreShell(),this.initCore(),this.initDisk(),this.setupGUI(),this.setupSettingsButton(),this.resizeHandler=()=>this.onWindowResize(),window.addEventListener(`resize`,this.resizeHandler),console.log(`✅ Animation34 彩虹奇点初始化成功`),!0}catch(e){throw console.error(`❌ Animation34 初始化失败:`,e),e}}setupThreeJS(){this.scene=new s,this.camera=new o(55,window.innerWidth/window.innerHeight,.1,500),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z),this.renderer=new d({canvas:this.canvas,antialias:!0,alpha:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=p,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=this.settings.exposure,this.renderer.setClearColor(0,0),this.canvas.style.backgroundColor=`transparent`,this.canvas.style.mixBlendMode=`screen`,this.canvas.style.zIndex=`1`,this.controls=new C(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.08,this.controls.minDistance=2,this.controls.maxDistance=1/0,this.controls.rotateSpeed=.8,this.controls.zoomSpeed=1.2,this.controls.target.set(0,0,0),this.controls.update(),this.controls.saveState()}setupComposer(){this.composer=new g(this.renderer),this.composer.addPass(new h(this.scene,this.camera)),this.bloomPass=new v(new t(window.innerWidth,window.innerHeight),this.settings.bloomStrength,this.settings.bloomRadius,this.settings.bloomThreshold),this.composer.addPass(this.bloomPass),Object.assign(this.bloomPass.blendMaterial,E(!0)),this.afterimagePass=new w(this.settings.afterimageDamp),D(this.afterimagePass),this.composer.addPass(this.afterimagePass),this.chromaPass=new m({uniforms:{tDiffuse:{value:null},amount:{value:this.settings.chromaticAmount}},vertexShader:`
        ...
        `,n),this.gpuCompute.setVariableDependencies(this.positionVariable,[this.positionVariable,this.velocityVariable]),this.gpuCompute.setVariableDependencies(this.velocityVariable,[this.positionVariable,this.velocityVariable]),this.positionVariable.material.uniforms.time={value:0},this.velocityVariable.material.uniforms.time={value:0},this.positionVariable.material.uniforms.dt={value:1},this.velocityVariable.material.uniforms.dt={value:1},this.velocityVariable.material.uniforms.uAudioEnergy={value:0},this.velocityVariable.material.uniforms.uBass={value:0},this.velocityVariable.material.uniforms.uMid={value:0},this.velocityVariable.material.uniforms.uBeatKick={value:0},this.velocityVariable.material.uniforms.uContainment={value:this.settings.particleContainment};let a=this.gpuCompute.init();a&&console.error(`GPU Compute 初始化失败:`,a)}initParticles(){let e=this.settings.particleGridSize,t=e*e,n=new f,r=new Float32Array(t*3),a=new Float32Array(t*2),o=0,s=0;for(let t=0;t<e;t++)for(let n=0;n<e;n++)r[o++]=0,r[o++]=0,r[o++]=0,a[s++]=n/(e-1),a[s++]=t/(e-1);n.setAttribute(`position`,new u(r,3)),n.setAttribute(`uv`,new u(a,2)),this.particleMaterial=new l({transparent:!0,depthWrite:!1,...E(),uniforms:{time:{value:0},energy:{value:0},texturePosition:{value:null},uParticleSize:{value:this.settings.particleSize},uEnergyAmplification:{value:this.settings.particleEnergyAmplification},uHueSpeed:{value:this.settings.hueSpeed},uHueRadiusScale:{value:this.settings.hueRadiusScale},uHueAngleScale:{value:this.settings.hueAngleScale},uHueAudioShift:{value:this.settings.hueAudioShift},uHueBrightness:{value:0},uHueBrightnessScale:{value:this.settings.hueBrightnessScale},uBrightness:{value:1}},vertexShader:`
            ...
            `}),this.particleMesh=new i(n,this.particleMaterial),this.scene.add(this.particleMesh)}syncParticleUniforms(){this.particleMaterial&&(this.particleMaterial.uniforms.uParticleSize.value=this.settings.particleSize,this.particleMaterial.uniforms.uEnergyAmplification.value=this.settings.particleEnergyAmplification,this.particleMaterial.uniforms.uHueSpeed.value=this.settings.hueSpeed,this.particleMaterial.uniforms.uHueRadiusScale.value=this.settings.hueRadiusScale,this.particleMaterial.uniforms.uHueAngleScale.value=this.settings.hueAngleScale,this.particleMaterial.uniforms.uHueAudioShift.value=this.settings.hueAudioShift,this.particleMaterial.uniforms.uHueBrightnessScale.value=this.settings.hueBrightnessScale)}reinitParticleSystem(){this.particleMesh&&(this.scene.remove(this.particleMesh),this.particleMesh.geometry.dispose(),this.particleMesh.material.dispose(),this.particleMesh=null,this.particleMaterial=null),this.gpuCompute&&=(this.gpuCompute.dispose(),null),this.initGPUCompute(),this.initParticles(),this.syncParticleUniforms()}initCoreShell(){let e=new c(1.8,4),t=new l({transparent:!0,depthWrite:!1,...E(),uniforms:{time:{value:0}},vertexShader:`
                uniform float time;
            ...
            `});this.coreShell=new r(e,t),this.scene.add(this.coreShell)}initCore(){this.core=new r(new c(1,8),new n({color:16777215,transparent:!0,...E(),depthWrite:!1})),this.scene.add(this.core)}initDisk(){let e=new a(2.5,6,96),t=new l({transparent:!0,side:2,...E(),uniforms:{time:{value:0},uDiskSpeed:{value:this.settings.diskSpeed},uDiskHueOffset:{value:this.settings.diskHueOffset},uDiskSaturation:{value:this.settings.diskSaturation},uDiskHueAudioShift:{value:this.settings.diskHueAudioShift},uAudioEnergy:{value:0}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
