import{Dr as e,Gt as t,Kt as n,Vt as r,Xn as i,Zn as a,f as o,l as s,r as c,u as l,vt as u}from"./three.module-TVF63cYk.js";import{n as d,r as f,t as p}from"./OutputPass-CxDAHfy4.js";import{a as m,i as h,n as g,r as _,t as v}from"./GUIHelper-DNd0uFVI.js";import{t as y}from"./UnrealBloomPass-C17ZlHgr.js";var b=class{constructor(e,t={}){this.canvas=e;let n={lyricsText:``,particleCount:22e3,particleSize:.6,transitionSpeed:.2,rotationEnabled:!1,textScale:1,graphicPosition:`center`,cameraPosition:{x:0,y:0,z:150},bloomStrength:.15,bloomRadius:.6,bloomThreshold:.9,particleJitter:.03,enableBloom:!0,particleBrightness:1,colorMode:5};this.settings={...n,...t},this.DEFAULTS=n,this.positionOptions={center:{name:`居中`,offsetX:0,offsetY:0},"top-left":{name:`左上角`,offsetX:-.25,offsetY:-.25},"top-right":{name:`右上角`,offsetX:.25,offsetY:-.25},"bottom-left":{name:`左下角`,offsetX:-.25,offsetY:.25},"bottom-right":{name:`右下角`,offsetX:.25,offsetY:.25},fullscreen:{name:`全屏`,offsetX:0,offsetY:0}},this.scene=null,this.camera=null,this.renderer=null,this.particles=null,this.composer=null,this.bloomPass=null,this.previousCanvasMixBlendMode=this.canvas.style.mixBlendMode,this.lyricsCoords=[],this.lastTime=0,this.transitionMultiplier=1,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this.audioFreq=0,this.bass=0,this.mid=0,this.high=0,this.beat=null,this.hasAudioData=!1,this.isPlaying=!0,this.motion=0,this.variation=0,this.brightness=0,this.percussive=0,this.smoothness=0,this.isDownbeat=!1,this.isMusicPaused=!1,this._disposed=!1,this._lyricsPatched=!1,this._initTimeoutId=null,this._lyricsRequestId=0,this.sampleCanvas=null,this.sampleContext=null,this._guiPreferencesLoading=!1,this._guiPreferencesStart=null,this.initPromise=this.init(),this.initPromise.then(()=>{this.lastTime=performance.now()*.001,this.animTime=0,this.initLyricsIntegration()}).catch(e=>{console.error(`❌ Animation12 初始化失败:`,e)})}async init(){try{return await this.setupThreeJS(),this.setupSampleCanvas(),await this.createGPUParticleSystem(),this.settings.lyricsText=``,await this.updateWithLyrics(this.settings.lyricsText),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),!0}catch(e){throw console.error(`❌ Animation12 初始化失败:`,e),e}}setupSampleCanvas(){this.sampleCanvas=document.createElement(`canvas`),this.sampleContext=this.sampleCanvas.getContext(`2d`,{willReadFrequently:!0}),this.sampleContext||console.warn(`无法获取Canvas 2D上下文，回退到传统方法`)}async setupThreeJS(){if(!this.checkWebGLSupport())throw Error(`WebGL不支持或已禁用`);this.scene=new i,this.camera=new r(75,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z);try{this.renderer=new c({canvas:this.canvas,antialias:!1,alpha:!0,powerPreference:`default`,preserveDrawingBuffer:!1})}catch(e){console.warn(`WebGL渲染器创建失败，尝试回退配置:`,e),this.renderer=new c({canvas:this.canvas,alpha:!0})}this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1)),this.renderer.outputColorSpace=u,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.mixBlendMode=`screen`,this.canvas.style.zIndex=`1`}checkWebGLSupport(){try{let e=document.createElement(`canvas`),t=e.getContext(`webgl`)||e.getContext(`experimental-webgl`);if(!t)return console.error(`❌ WebGL不支持`),!1;let n=t.getParameter(t.MAX_VERTEX_ATTRIBS),r=t.getParameter(t.MAX_TEXTURE_SIZE);return t.getParameter(t.MAX_VERTEX_TEXTURE_IMAGE_UNITS),n<8&&(console.warn(`⚠️ WebGL顶点属性数量不足，调整粒子配置`),this.settings.particleCount=Math.min(this.settings.particleCount,3e3)),r<2048&&(console.warn(`⚠️ WebGL纹理尺寸限制，调整Bloom效果`),this.settings.bloomStrength=Math.min(this.settings.bloomStrength,.3)),!0}catch(e){return console.error(`❌ WebGL能力检测失败:`,e),!1}}setupPostProcessing(){this.composer=new f(this.renderer);let t=new d(this.scene,this.camera);this.composer.addPass(t),this.bloomPass=new y(new e(window.innerWidth,window.innerHeight),this.settings.bloomStrength,this.settings.bloomRadius,this.settings.bloomThreshold),this.composer.addPass(this.bloomPass),Object.assign(this.bloomPass.blendMaterial,this.getTransparentLightBlending(!0)),this.composer.addPass(new p)}getTransparentLightBlending(e=!1){return{blending:5,blendEquation:100,blendSrc:e?201:204,blendDst:201,blendEquationAlpha:100,blendSrcAlpha:200,blendDstAlpha:201,premultipliedAlpha:e}}createGPUParticleMaterial(){try{return new a({uniforms:{time:{value:0},transitionSpeed:{value:this.settings.transitionSpeed},particleJitter:{value:this.settings.particleJitter*.5},bass:{value:0},mid:{value:0},high:{value:0},motion:{value:0},variation:{value:0},brightness:{value:0},percussive:{value:0},size:{value:this.settings.particleSize},colorMode:{value:this.settings.colorMode},uBrightness:{value:1},uSmoothness:{value:.5}},vertexShader:`
