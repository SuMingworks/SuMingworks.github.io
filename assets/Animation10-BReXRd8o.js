import{a as e}from"./lil-gui.esm-jlbWO7FJ.js";import{Dr as t,Gt as n,Vt as r,Xn as i,Zn as a,bt as o,cr as s,g as c,l,r as u,u as d,vt as f}from"./three.module-TVF63cYk.js";import{n as p,r as m,t as h}from"./OutputPass-CxDAHfy4.js";import{t as g}from"./UnrealBloomPass-C17ZlHgr.js";import{i as _,n as v,r as y,t as b}from"./GUIHelper-DspWBXk2.js";import{t as x}from"./OrbitControls-Ju8LL-qO.js";var S=class{constructor(e,t={}){this.canvas=e,this.TRAIL_COUNT=5e3,this.TRAIL_LENGTH=20;let n={particleSize:3,morphDrive:1,morphAmount:1,bloomStrength:.1,bloomRadius:.15,bloomThreshold:.8,bloomBeatResponse:.1,audioBassImpact:1,audioMidImpact:1,audioHighImpact:1,autoRotate:!1,flowStrength:.08,particleCount:15e4,trailGlow:.8,kickImpact:.2,downbeatImpact:1,particleBrightness:1,cameraPosition:{x:0,y:25,z:20},color:`#ffd43b`,hueVariation:.5,saturationBoost:1.8};this.settings={...n,...t},this.defaultSettings=n,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.previousCanvasMixBlendMode=this.canvas.style.mixBlendMode,this.particleSystem=null,this.particleMaterial=null,this.particleGeometry=null,this.trailMesh=null,this.trailMaterial3D=null,this.bass=0,this.mid=0,this.high=0,this.kickDetected=0,this.snareDetected=0,this.hihatDetected=0,this.downbeatDetected=0,this.motion=0,this.variation=0,this.energy=0,this.percussive=0,this.smoothness=0,this.hasAudioData=!1,this.morphValue=0,this.autoMin=.15,this.autoMax=.85,this.morphSlow=.5,this.prevFast=.5,this.morphTransient=0,this.hue=.13,this.baseHue=this.hexToBaseHue(this.settings.color),this.elapsedTime=0,this.lastFrameTime=0,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this.isRebuilding=!1,this.init().catch(e=>{console.error(`❌ Animation10 初始化失败:`,e)})}async init(){try{return await this.setupThreeJS(),this.createParticles(this.settings.particleCount),this.createRibbonTrail(),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),console.log(`✅ Animation10 初始化成功`),!0}catch(e){throw console.error(`❌ Animation10 初始化失败:`,e),e}}async setupThreeJS(){this.scene=new i,this.camera=new r(45,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z),this.camera.lookAt(0,0,0),this.renderer=new u({canvas:this.canvas,antialias:!0,alpha:!0,powerPreference:`high-performance`,toneMapping:4,toneMappingExposure:1}),this.renderer.outputColorSpace=f,this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.canvas.style.backgroundColor=`transparent`,this.canvas.style.mixBlendMode=`screen`,this.canvas.style.zIndex=`1`,this.controls=new x(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.autoRotate=!1,this.controls.target.set(0,0,0),this.controls.minDistance=1.5,this.controls.maxDistance=25,this.controls.enablePan=!0,this.controls.mouseButtons={LEFT:o.ROTATE,MIDDLE:o.DOLLY,RIGHT:o.PAN},this.controls.touches={ONE:s.ROTATE_PAN,TWO:s.DOLLY_PAN}}createParticles(e){this.particleSystem&&(this.scene.remove(this.particleSystem),this.particleGeometry&&this.particleGeometry.dispose(),this.particleMaterial&&this.particleMaterial.dispose());let t=Math.floor(e),r=new d;this.particleGeometry=r;let i=new Float32Array(t*3),o=new Float32Array(t),s=new Float32Array(t),u=new Float32Array(t*3),f=new Float32Array(t*3),p=new Float32Array(t),m=new Float32Array(t),h=Math.max(1,Math.floor(t/16));for(let e=0;e<t;e++){let t=e%16,n=(Math.floor(e/16)+.5)/h,r,a;t<8?(r=t/8*Math.PI*2,a=n*Math.PI):(a=(t-8+.5)/8*Math.PI,r=n*Math.PI*2);let c=3+Math.random()*.05,l=Math.sin(a)*Math.cos(r)*c,d=Math.cos(a)*c,g=Math.sin(a)*Math.sin(r)*c;i[e*3+0]=l,i[e*3+1]=d,i[e*3+2]=g,u[e*3+0]=l,u[e*3+1]=d,u[e*3+2]=g,o[e]=Math.random(),s[e]=.15+Math.random()*.25,f[e*3+0]=(Math.random()-.5)*.004,f[e*3+1]=(Math.random()-.5)*.004,f[e*3+2]=(Math.random()-.5)*.004,p[e]=Math.random(),m[e]=Math.random()*100}r.setAttribute(`position`,new l(i,3)),r.setAttribute(`seed`,new l(o,1)),r.setAttribute(`size`,new l(s,1)),r.setAttribute(`basePos`,new l(u,3)),r.setAttribute(`velocity`,new l(f,3)),r.setAttribute(`lifePhase`,new l(p,1)),r.setAttribute(`flowSeed`,new l(m,1)),this.particleMaterial=new a({transparent:!0,depthWrite:!1,...this.getTransparentLightBlending(),uniforms:{time:{value:0},particleSize:{value:this.settings.particleSize},morph:{value:0},morphAmount:{value:this.settings.morphAmount},bass:{value:0},mid:{value:0},high:{value:0},flowStrength:{value:this.settings.flowStrength},kickDetected:{value:0},snareDetected:{value:0},hihatDetected:{value:0},motion:{value:0},brightness:{value:this.settings.particleBrightness},uColor:{value:new c(this.settings.color)},uHueShift:{value:0},uColorIntensity:{value:1},uBrightnessFeat:{value:0},uDownbeat:{value:0},uTime:{value:0},uVariation:{value:0}},vertexShader:`
                uniform float time;
            ...
            `}),this.particleSystem=new n(r,this.particleMaterial),this.scene.add(this.particleSystem),this.trailMesh&&(this.scene.remove(this.trailMesh),this.trailMesh.geometry&&this.trailMesh.geometry.dispose(),this.trailMaterial3D&&this.trailMaterial3D.dispose(),this.createRibbonTrail())}createRibbonTrail(){let e=this.TRAIL_LENGTH-1,t=this.TRAIL_COUNT*e*2,r=new Float32Array(t*3),i=new Float32Array(t*3),o=new Float32Array(t),s=new d;s.setAttribute(`position`,new l(r,3)),s.setAttribute(`color`,new l(i,3)),s.setAttribute(`alpha`,new l(o,1));let c=new Float32Array(this.TRAIL_COUNT*this.TRAIL_LENGTH*3);this.trailMaterial3D=new a({transparent:!0,depthWrite:!1,...this.getTransparentLightBlending(),uniforms:{bass:{value:0},mid:{value:0},high:{value:0},kickDetected:{value:0},snareDetected:{value:0},hihatDetected:{value:0},trailGlow:{value:this.settings.trailGlow}},vertexShader:`
