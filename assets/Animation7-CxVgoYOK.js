import{Dr as e,Gt as t,Vt as n,Xn as r,Zn as i,f as a,g as o,l as s,r as c,u as l,vt as u}from"./three.module-TVF63cYk.js";import{n as d,r as f,t as p}from"./OutputPass-CxDAHfy4.js";import{a as m,i as h,n as g,r as _,t as v}from"./GUIHelper-DNd0uFVI.js";import{t as y}from"./UnrealBloomPass-C17ZlHgr.js";import{t as b}from"./OrbitControls-Ju8LL-qO.js";var x=(e=!1)=>({blending:5,blendEquation:100,blendSrc:e?201:204,blendDst:201,blendEquationAlpha:100,blendSrcAlpha:e?200:201,blendDstAlpha:e?201:205,premultipliedAlpha:e}),S=e=>Object.assign(e.blendMaterial,x(!0)),C=1e5,w=1e3,T=class{constructor(e,t={}){this.canvas=e,this.colorThemes={rainbow:{name:`彩虹律动`,baseColor:`#ffd43b`,hueVariation:.5,saturationBoost:1.8},monochrome:{name:`单色渐变`,baseColor:`#ffffff`,hueVariation:0,saturationBoost:0}};let n={color:`#ffd43b`,colorTheme:`rainbow`,bloomStrength:.15,bloomRadius:.1,bloomThreshold:.9,audioSensitivity:1,wingWidth:3,zWidth:.4,autoRotate:!1,particleSize:2.6,particleCount:45e3,cameraPosition:{x:0,y:2,z:12},particleBrightness:1,trailRatio:.25,trailSize:2.6,trailBrightness:1,trailOpacity:1,motionIntensity:.6,brightnessIntensity:1,textureIntensity:0,smoothnessIntensity:1,variationIntensity:0};this.settings={...n,...t},this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.particleSystem=null,this.geometry=null,this.shaderMaterial=null,this.particleCount=this.settings.particleCount,this.audioFreq=0,this.lowFreq=0,this.bass=0,this.mid=0,this.high=0,this.smoothedAudioFreq=0,this.smoothedLowFreq=0,this.motionVal=0,this.brightnessVal=0,this.textureVal=0,this.smoothnessVal=0,this.variationVal=0,this.kickTrigger=0,this.snareTrigger=0,this.hihatTrigger=0,this.downbeatTrigger=0,this.smoothedKick=0,this.smoothedSnare=0,this.smoothedHihat=0,this.smoothedDownbeat=0,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.hasAudioData=!1,this.settingsButton=null,this.init()}init(){try{return this.setupThreeJS(),this.createParticleSystem(),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),console.log(`✅ Animation7 初始化成功`),!0}catch(e){throw console.error(`❌ Animation7 初始化失败:`,e),e}}setupThreeJS(){this.scene=new r,this.camera=new n(50,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z),this.camera.lookAt(0,1,0),this.renderer=new c({canvas:this.canvas,antialias:!0,alpha:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=u,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`,this.controls=new b(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.target.set(0,1,0),this.controls.saveState(),this.crystalTexture=this.createCrystalTexture()}createCrystalTexture(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);t.fillStyle=`black`,t.fillRect(0,0,64,64);let n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255, 255, 255, 1)`),n.addColorStop(.2,`rgba(200, 230, 255, 0.8)`),n.addColorStop(.5,`rgba(50, 100, 255, 0.2)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.beginPath(),t.arc(32,32,30,0,Math.PI*2),t.fill(),t.strokeStyle=`rgba(255, 255, 255, 0.5)`,t.lineWidth=1,t.beginPath(),t.moveTo(32,10),t.lineTo(32,54),t.moveTo(10,32),t.lineTo(54,32),t.stroke(),new a(e)}createParticleSystem(){if(this.particleSystem){this.setParticleCount(this.settings.particleCount);return}this.particleCount=this.clampParticleCount(this.settings.particleCount),this.geometry=new l;let e=new Float32Array(C*3),n=new Float32Array(C*3);for(let t=0;t<C;t++){let r=Math.random()>.5?1:-1,i=Math.random(),a=i**2*this.settings.wingWidth*r,o=i**.5*4+(Math.random()-.5)*.5;a*=o*.5,e[t*3]=a,e[t*3+1]=o-1,e[t*3+2]=(Math.random()-.5)*this.settings.zWidth,n[t*3]=.2+Math.random()*.5,n[t*3+1]=Math.random()*Math.PI*2,n[t*3+2]=+(Math.random()<this.settings.trailRatio)}this.geometry.setAttribute(`position`,new s(e,3)),this.geometry.setAttribute(`extra`,new s(n,3)),this.geometry.setDrawRange(0,this.particleCount),this.shaderMaterial=new i({uniforms:{uTime:{value:0},uColor:{value:new o(this.settings.color)},uTexture:{value:this.crystalTexture},uAudioFreq:{value:0},uLowFreq:{value:0},uSize:{value:this.settings.particleSize},uTrailSize:{value:this.settings.trailSize},uColorIntensity:{value:1},uHueShift:{value:0},uBrightness:{value:this.settings.particleBrightness},uTrailBrightness:{value:this.settings.trailBrightness},uTrailOpacity:{value:this.settings.trailOpacity},uMotion:{value:0},uBrightnessFeat:{value:0},uTextureFeat:{value:0},uSmoothness:{value:0},uVariation:{value:0},uKick:{value:0},uSnare:{value:0},uHihat:{value:0},uDownbeat:{value:0}},vertexShader:`
                uniform float uTime;
                ...
                void main() {
                    ...
                    if(vIsTrail > 0.5) {
                        ...
                        pos.y -= drop;
                        // 保留平滑度对拖尾的影响，但提高透明度下限，让翅膀下方的小粒子更清晰
                        float smoothFactor = mix(1.0, 0.55, min(uSmoothness, 1.0));
                        vOpacity = (1.0 - drop / 12.0) * (0.8 + uLowFreq) * smoothFactor;
                    } else {
                    ...
                    float pointSize = vIsTrail > 0.5 ? uTrailSize : uSize;
                    gl_PointSize = pointSize * varScale * (25.0 / max(6.0, -mvPosition.z));
