import{Et as e,Gt as t,Jn as n,K as r,Or as i,St as a,Vt as o,Xn as s,Zn as c,g as l,nr as u,r as d,u as f,z as p}from"./three.module-TVF63cYk.js";import{n as m,r as h,t as g}from"./OutputPass-CxDAHfy4.js";import{a as _,i as v,n as y,r as b,t as x}from"./GUIHelper-DNd0uFVI.js";import{t as ee}from"./OrbitControls-Ju8LL-qO.js";var S=()=>({blending:5,blendEquation:100,blendSrc:204,blendDst:201,blendEquationAlpha:100,blendSrcAlpha:200,blendDstAlpha:201}),C=e=>Math.min(1,Math.max(0,e));function w(e){let[t,n,r]=e,i=.4122214708*t+.5363325363*n+.0514459929*r,a=.2119034982*t+.6806995451*n+.1073969566*r,o=.0883024619*t+.2817188376*n+.6299787005*r,s=Math.cbrt(Math.max(0,i)),c=Math.cbrt(Math.max(0,a)),l=Math.cbrt(Math.max(0,o));return[.2104542553*s+.793617785*c-.0040720468*l,1.9779984951*s-2.428592205*c+.4505937099*l,.0259040371*s+.7827717662*c-.808675766*l]}function T(e){let[t,n,r]=e,i=t+.3963377774*n+.2158037573*r,a=t-.1055613458*n-.0638541728*r,o=t-.0894841775*n-1.291485548*r,s=i*i*i,c=a*a*a,l=o*o*o;return[4.0767416621*s-3.3077115913*c+.2309699292*l,-1.2684380046*s+2.6097574011*c-.3413193965*l,-.0041960863*s-.7034186147*c+1.707614701*l]}function E(e){let t=new l(e);return w([t.r,t.g,t.b])}function D(e,t,n){let r=C(Number(n)||0);return[e[0]+(t[0]-e[0])*r,e[1]+(t[1]-e[1])*r,e[2]+(t[2]-e[2])*r]}function te(e,t,{preserveChroma:n=1,maxChromaScale:r=2}={}){let i=0,a=0,o=0,s=0;for(let n=0;n<e.length;n++){let r=Math.max(0,Number(t[n])||0);i+=r,a+=e[n][0]*r,o+=e[n][1]*r,s+=e[n][2]*r}if(i<=1e-8)return e[0].slice();let c=[a/i,o/i,s/i],l=e.reduce((e,n,r)=>e+Math.hypot(n[1],n[2])*Math.max(0,Number(t[r])||0),0)/i,u=Math.hypot(c[1],c[2]);if(u>1e-8&&l>u){let e=Math.min(r,1+(l/u-1)*n);c[1]*=e,c[2]*=e}return c}function ne(e){let[t,n,r]=e,i=r*Math.PI*2;return[t,n*Math.cos(i),n*Math.sin(i)]}function re(e,{maxValue:t=1}={}){let n=T(e),r=e.slice();for(let e=0;e<8&&Math.min(...n)<-1e-5;e++)r[1]*=.82,r[2]*=.82,n=T(r);return n.map(e=>Math.min(t,Math.max(0,e)))}function ie(e,{threshold:t=1,headroom:n=.28,softness:r=.58}={}){let i=Math.max(1e-5,r);return e.map(e=>{let r=Math.max(0,e);if(r<=t)return r;let a=r-t;return t+n*(1-Math.exp(-a/i))})}function O(e){return typeof structuredClone==`function`?structuredClone(e):JSON.parse(JSON.stringify(e))}function k(e,t={}){let n=O(e);for(let[e,r]of Object.entries(t||{}))r&&typeof r==`object`&&!Array.isArray(r)&&n[e]&&typeof n[e]==`object`?Object.assign(n[e],r):n[e]=r;return n}var A={camera:{distance:32,fov:42,autoOrbit:.028},sphere:{radius:10,shellOpacity:.86,rimStrength:1.42,rimPower:4.65,edgeVariation:.68,atmosphere:.105},far:{count:9200,size:1.78,brightness:1.045,shellBias:.4},mid:{count:3600,size:2.73,brightness:.98,shellBias:.48},near:{count:1020,size:4.7,brightness:1.82,cameraBias:.667},hero:{probability:.0215,size:15.2,brightness:3.46},naturalField:{strength:.289,scale:.341,depthVariation:.18,offsetX:.12,offsetY:-.08,offsetZ:.16},composition:{riverRatio:.315,satelliteRatio:.078,riverWidth:1.48,riverFlatten:.46,riverTurbulence:.39,quietStrength:.58,islandStretch:1.58,balanceStrength:.24,brightBalance:.82},dust:{count:1240,size:2.92,opacity:.205,drift:.323},motion:{rotationY:.066,rotationX:.028,twinkle:.54,starDrift:.245},livingFlow:{speed:.0175,curlStrength:.44,confinement:.64,stability:.94,influence:.94,pulseWidth:.09,pulseStrength:.92,vfxStrength:.72,trailStrength:.46,releaseStrength:.39,vortexEvent:.46},audioReactive:{enabled:!0,strength:.82,motion:.58,brightness:.52,pulse:.88,tempoSync:.72,ambient:1.05,dust:1.35,color:1.15},colorDirector:{enabled:!0,intensity:1.32,coverage:1.08,transitionSpeed:1.18,eventIntensity:1.28,peakAccent:1.12},colorSection:{sensitivity:1,calmThreshold:.22,peakThreshold:.66,trendThreshold:.08,relativeThreshold:.57,variationThreshold:.18,minHold:2.5,transitionDuration:3.2},shellColor:{response:1,coverage:1,sectionInfluence:1,downbeatInfluence:1,basePreservation:.04},riverColor:{response:1,coverage:1,highInfluence:.72,kickAccent:1,impactAccent:.95},ambientStarColor:{response:1,coverage:.88,complementary:.82,depthSeparation:.35,snareSpread:.95,variationInfluence:.72},dustColor:{response:1,coverage:.94,highInfluence:1,variationInfluence:.78,hihatAccent:1},heroColor:{response:1,kickAccent:.62,impactAccent:1,downbeatAccent:1,warmPeak:.92,colorCoverage:1},environmentColor:{atmosphereResponse:.9},colorEnvelope:{kickRelease:.25,snareRelease:.36,hihatRelease:.1,impactRelease:.3,downbeatRelease:.55},colors:{blue:`#4969f2`,cyan:`#64d8ff`,violet:`#8b5cf0`,white:`#f4f7ff`,warm:`#f3c9a7`,rim:`#5364cf`},performance:{dpr:1.2}},j=class{constructor(e,t={}){this.canvas=e,this._guiPreferencesLoading=!1,this._pendingInteriorRebuild=!1,this.settings=k(A,t),this.params=this.settings,this.initialCameraDistance=this.params.camera.distance,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.renderPass=null,this.outputPass=null,this.universe=null,this.atmosphereGroup=null,this.starsGroup=null,this.dustGroup=null,this.shellGroup=null,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this.hasAudioData=!1,this.audioFrame=null,this.elapsed=0,this.lastTime=performance.now()*.001,this.startTime=this.lastTime,this._core=null,this._disposed=!1,this.init()}init(){return this._disposed?!1:this.scene?!0:(this.setupThreeJS(),this._disposed||(this.createVisualCore(),this._disposed)||(this.setupPostProcessing(),this._disposed)?!1:(this.setupGUI(),this.setupSettingsButton(),console.log(`✅ Animation66 初始化成功`),!0))}setupThreeJS(){let e=this.params;this.scene=new s,this.camera=new o(e.camera.fov,Math.max(1,window.innerWidth)/Math.max(1,window.innerHeight),.1,120),this.camera.position.set(0,0,e.camera.distance),this.renderer=new d({canvas:this.canvas,antialias:!0,alpha:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,e.performance.dpr)),this.renderer.setSize(Math.max(1,window.innerWidth),Math.max(1,window.innerHeight),!1),this.renderer.setClearColor(0,0),this.renderer.outputColorSpace=n,this.renderer.toneMapping=0,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`,this.controls=new ee(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.055,this.controls.enablePan=!1,this.controls.minDistance=15,this.controls.maxDistance=46,this.controls.autoRotate=e.camera.autoOrbit>0,this.controls.autoRotateSpeed=e.camera.autoOrbit,this.controls.target.set(0,0,0),this.controls.saveState(),this.universe=new r,this.atmosphereGroup=new r,this.starsGroup=new r,this.dustGroup=new r,this.shellGroup=new r,this.universe.add(this.atmosphereGroup,this.starsGroup,this.dustGroup,this.shellGroup),this.scene.add(this.universe)}createVisualCore(){let n=this,r=this.params,o=this.renderer;this.scene;let s=this.camera,d=this.controls,m=this.universe,h=this.atmosphereGroup,g=this.starsGroup,_=this.dustGroup,v=this.shellGroup;function y(e){let t=new l(e);return new i(t.r,t.g,t.b)}function b(e){return function(){let t=e+=1831565813;return t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296}}let x=b(26288166);function ee(){x=b(26288166)}function C(){let e=x()*2-1,t=x()*Math.PI*2,n=Math.sqrt(Math.max(0,1-e*e));return new i(n*Math.cos(t),n*Math.sin(t),e)}function w(e,t){return C().multiplyScalar(x()**+t*e)}let T=[new i(-7.35,-2.75,-2.55),new i(-5.65,-1.55,1.55),new i(-3.2,.4,3.05),new i(-.95,1.2,1.1),new i(1.05,-.45,-2.65),new i(3.35,.5,-3.05),new i(5.25,2.15,-.65),new i(7.05,3.25,2.1)];function O(e,t,n,r,a,o=new i){let s=a*a,c=s*a;return o.set(0,0,0).addScaledVector(t,2).addScaledVector(e,-a+2*s-c).addScaledVector(t,-5*s+3*c).addScaledVector(n,a+4*s-3*c).addScaledVector(r,-s+c).multiplyScalar(.5)}function k(e){let t=a.clamp(e,0,.999999)*7,n=Math.floor(t),r=t-n,i=n,o=Math.min(n+1,7),s=Math.max(i-1,0),c=Math.min(o+1,7);return O(T[s],T[i],T[o],T[c],r)}function A(e){let t=.0025,n=k(Math.max(0,e-t));return k(Math.min(.99999,e+t)).sub(n).normalize()}function j(e){let t=A(e),n=Math.abs(t.y)<.88?new i(0,1,0):new i(1,0,0),r=new i().crossVectors(t,n).normalize(),a=new i().crossVectors(t,r).normalize(),o=Math.sin(e*Math.PI*2.15-.55)*.48+Math.sin(e*Math.PI*4.1+.8)*.11,s=Math.cos(o),c=Math.sin(o);return{tangent:t,normal:r.clone().multiplyScalar(s).addScaledVector(a,c),binormal:a.clone().multiplyScalar(s).addScaledVector(r,-c)}}function ae(e){let t=.34+.66*Math.sin(Math.PI*a.clamp(e,0,1))**.46,n=.72*Math.exp(-(((e-.27)/.13)**2)),i=.46*Math.exp(-(((e-.52)/.085)**2)),o=.88*Math.exp(-(((e-.76)/.14)**2)),s=(.68+n-i+o)*t;return r.composition.riverWidth*Math.max(.3,s)}function oe(e){let t=.52*Math.exp(-(((e-.18)/.12)**2)),n=1.02*Math.exp(-(((e-.36)/.105)**2)),r=.42*Math.exp(-(((e-.53)/.075)**2)),i=1.16*Math.exp(-(((e-.7)/.11)**2)),o=.68*Math.exp(-(((e-.86)/.095)**2)),s=Math.sin(Math.PI*a.clamp(e,0,1))**.34;return Math.max(.1,(.25+t+n-r+i+o)*s)}function se(){for(let e=0;e<18;e++){let e=x();if(x()<Math.min(1,oe(e)/1.48))return e}return .18+x()*.7}function ce(e){let t=1e9,n=0;for(let r=0;r<=46;r++){let i=r/46,a=k(i),o=e.distanceToSquared(a);o<t&&(t=o,n=i)}let r=Math.max(.34,ae(n)),i=Math.sqrt(t),a=Math.exp(-(i*i)/(2*r*r));return{t:n,d:i,width:r,affinity:a}}function le(e,t){let n=se(),i=k(n),{normal:o,binormal:s}=j(n),c=ae(n),l=e===`far`?1.28:e===`mid`?1:.72,u=Math.exp(-(((n-.53)/.115)**2)),d=c*l*.1*u,f=c*l,p=a.lerp(d,f,x()**.58),m=x()*Math.PI*2,h=r.composition.riverFlatten,g=.88+.12*Math.sin(n*17+m*2.4),_=Math.cos(m)*p*g,v=Math.sin(m)*p*h*(.72+.26*Math.sin(n*8.5+1.1)),y=i.clone().addScaledVector(o,_).addScaledVector(s,v),b=r.composition.riverTurbulence;return y.addScaledVector(o,Math.sin(n*27+m*1.7)*b*.12*c),y.addScaledVector(s,Math.cos(n*19-m*1.2)*b*.08*c),y.length()>t&&y.setLength(t*(.9+x()*.05)),{p:y,t:n,lane:p/Math.max(c,.001),width:c}}let M=[{t:.22,n:2.55,b:-1.3,sx:2.9,sy:.62,phase:.2},{t:.61,n:-2.35,b:1.55,sx:2.6,sy:.58,phase:2.5},{t:.82,n:1.75,b:1.2,sx:3.2,sy:.68,phase:4.4}];function ue(e,t){let n=M[Math.min(M.length-1,Math.floor(x()*M.length))],i=a.clamp(n.t+(x()-.5)*.105,0,1),o=k(i),{tangent:s,normal:c,binormal:l}=j(i),u=e===`far`?1.16:e===`mid`?1:.76,d=x()+x()+x()+x()-2,f=x()+x()+x()+x()-2,p=d*n.sx*r.composition.islandStretch*u,m=f*n.sy*u,h=.34*Math.tanh(Math.abs(p)*.55),g=o.clone().addScaledVector(c,n.n*(1-h*.18)).addScaledVector(l,n.b).addScaledVector(s,p).addScaledVector(c,m).addScaledVector(l,m*.42*Math.sin(n.phase+i*9)).addScaledVector(c,-Math.sign(n.n||1)*Math.abs(p)*h*.16);return g.length()>t&&g.setLength(t*(.84+x()*.085)),{p:g,t:i,lane:1.18+Math.abs(m)/(n.sy+.001)}}function de(e){let t=[[new i(-4.75,4.05,1.65),2.85],[new i(4.7,-3.85,-1.75),2.95],[new i(-.35,-5.05,1.35),2.4],[new i(1.2,4.85,-2.25),2.15]],n=0;for(let[r,i]of t){let t=e.distanceTo(r);n=Math.max(n,Math.exp(-(t*t)/(2*i*i)))}return n}function fe(e,t=0){let n=r.naturalField.scale,i=Math.cos(t),o=Math.sin(t),s=e.x*i-e.z*o,c=e.x*o+e.z*i,l=s+r.naturalField.offsetX,u=e.y+r.naturalField.offsetY,d=c+r.naturalField.offsetZ,f=Math.sin(l*n*.78+u*n*.41-d*n*.32+.7*t),p=Math.sin(-l*n*.27+u*n*.87+d*n*.51+1.35-.3*t),m=Math.sin(l*n*.45-u*n*.24+d*n*.69-.55+.6*t),h=Math.sin(d*n*.43+l*n*.15-u*n*.08)*r.naturalField.depthVariation,g=f*.3+p*.24+m*.18+h,_=de(e)*r.composition.quietStrength,v=ce(e).affinity*.18;return a.clamp(1+g*r.naturalField.strength-_-v,.5,1.26)}function pe(){return{total:0,xp:0,xn:0,yp:0,yn:0,zp:0,zn:0,wxp:0,wxn:0,wyp:0,wyn:0}}function N(e,t){if(!t||t.total<24)return 1;let n=t.total*.5,i=e.x>=0?`xp`:`xn`,o=e.y>=0?`yp`:`yn`,s=e.z>=0?`zp`:`zn`,c=(t[i]-n)/Math.max(n,1)+(t[o]-n)/Math.max(n,1)*.52+(t[s]-n)/Math.max(n,1)*.25;return a.clamp(1-c*r.composition.balanceStrength,.7,1.3)}function me(e,t,n,r){let i=a.clamp(t*n*N(e,r),.12,.96);return x()>i?!1:(r.total++,r[e.x>=0?`xp`:`xn`]++,r[e.y>=0?`yp`:`yn`]++,r[e.z>=0?`zp`:`zn`]++,!0)}function he(e,t,n){if(!t||t.total<30||n<1.15)return 1;let i=e.x>=0?t.wxp:t.wxn,o=e.x>=0?t.wxn:t.wxp,s=e.y>=0?t.wyp:t.wyn,c=e.y>=0?t.wyn:t.wyp,l=(i-o)/Math.max(6,i+o)+.52*(s-c)/Math.max(6,s+c);return a.clamp(1-l*r.composition.brightBalance,.42,1.18)}function ge(e,t,n){t&&(e.x>=0?t.wxp+=n:t.wxn+=n,e.y>=0?t.wyp+=n:t.wyn+=n)}function _e(e,t,n){if(e===`river`){let e=Math.exp(-(((t-.36)/.11)**2)),r=Math.exp(-(((t-.7)/.12)**2)),i=Math.exp(-(((t-.88)/.12)**2)),o=.16+.34*t+.42*Math.max(e,r)-.28*i;return o=a.clamp(o+(n-.5)*.075,0,1),P(o)}return P(e===`satellite`?a.clamp(.22+n*.58,0,1):n)}function P(e){let t=new l(r.colors.blue),n=new l(r.colors.cyan),i=new l(r.colors.violet),a=new l(r.colors.white),o=new l(r.colors.warm);return e<.46?t.clone().lerp(n,e/.46):e<.86?n.clone().lerp(i,(e-.46)/.4):e<.965?i.clone().lerp(a,(e-.86)/.105):a.clone().lerp(o,(e-.965)/.035)}function ve(e,t,n,r,i,a,o,s=[],c=[],l=[],u=[]){let d=new f;d.setAttribute(`position`,new p(e,3)),d.setAttribute(`color`,new p(t,3)),d.setAttribute(`aSize`,new p(n,1)),d.setAttribute(`aAlpha`,new p(r,1)),d.setAttribute(`aPhase`,new p(i,1)),d.setAttribute(`aDepth`,new p(a,1)),d.setAttribute(`aLuminosity`,new p(o,1));let m=e.length/3,h=(e,t)=>e.length===m?e:Array(m).fill(t);return d.setAttribute(`aFlowAffinity`,new p(h(s,0),1)),d.setAttribute(`aFlowPhase`,new p(h(c,0),1)),d.setAttribute(`aFlowLane`,new p(h(l,0),1)),d.setAttribute(`aFlowSpeed`,new p(h(u,0),1)),d}function ye(e){let t=Math.max(x(),1e-6),n=1;if(n=e===`far`?.78+t**7.5*.72:e===`mid`?.88+t**6*1.55:.96+t**4.2*2.55,x()<r.hero.probability){let e=x()**.42;n*=a.lerp(1.65,r.hero.brightness,e)}return n}function be(e,t,n){let i=Math.max(t-1,0),o=1+i**.58*.22;n===`near`&&(o*=1+i**.72*.1);let s=a.clamp((t-1.45)/3.2,0,1),c=a.clamp(.55+r.hero.size*.0475,.7,1.5);return o*=a.lerp(1,c,s),e*o}function xe(e){let t=Math.round(e*r.composition.riverRatio),n=Math.round(e*r.composition.satelliteRatio);return{ambient:Math.max(0,e-t-n),river:t,satellite:n}}function Se(e,t,n,i,o=0,s=0,c=null){let l=r.sphere.radius*(n===`far`?.94:n===`mid`?.92:.9),u=ye(n);if(i===`river`){let e=Math.exp(-(((o-.36)/.105)**2)),t=Math.exp(-(((o-.7)/.115)**2)),n=Math.exp(-(((o-.53)/.08)**2));u*=a.clamp(.91+e*.15+t*.23-n*.1,.78,1.26)}i===`satellite`&&(u*=.94+x()*.12);let d=he(t,c,Math.max(u,1)**1.4);u>1.55&&x()>d&&(u=1.05+(u-1.05)*.46);let f=be((n===`far`?r.far.size:n===`mid`?r.mid.size:r.near.size)*(n===`far`?.5+x()*.72:n===`mid`?.58+x()*.88:.66+x()*.98),u,n);if(i===`river`){let e=Math.max(Math.exp(-(((o-.36)/.115)**2)),Math.exp(-(((o-.7)/.125)**2))),t=Math.exp(-(((o-.53)/.085)**2));f*=1+e*.1+Math.exp(-s*s*1.6)*.035-t*.055}let p=n===`far`?.17+x()*.42:n===`mid`?.28+x()*.54:.42+x()*.5,m=i===`ambient`?.88:i===`river`?1:.96;i===`river`&&(m*=a.clamp(.84+oe(o)*.2,.82,1.12));let h=a.clamp(p*m,.1,1),g=_e(i,o,x());if(e.P.push(t.x,t.y,t.z),e.C.push(g.r,g.g,g.b),e.S.push(f),e.A.push(h),e.H.push(x()*Math.PI*2),e.D.push(t.length()/l),e.L.push(u),i===`river`)e.FA.push(a.clamp(1-s*.34,.34,1)),e.FP.push(o),e.FL.push(s),e.FS.push((n===`far`?.78:n===`mid`?.96:1.1)*(.82+x()*.42));else{let r=ce(t);e.FA.push(i===`satellite`?a.clamp(Math.max(r.affinity*.52,.2),.2,.58):r.affinity*.28),e.FP.push(r.t),e.FL.push(r.d/Math.max(r.width,.001)),e.FS.push((n===`far`?.58:n===`mid`?.7:.82)*(.8+x()*.35))}ge(t,c,f*h*Math.max(u,.8)**1.15*.1)}function Ce(){return{P:[],C:[],S:[],A:[],H:[],D:[],L:[],FA:[],FP:[],FL:[],FS:[]}}function F(e){return ve(e.P,e.C,e.S,e.A,e.H,e.D,e.L,e.FA,e.FP,e.FL,e.FS)}function we(e,t,n,r,i){let a=new f;return a.setAttribute(`position`,new p(e,3)),a.setAttribute(`color`,new p(t,3)),a.setAttribute(`aSize`,new p(n,1)),a.setAttribute(`aAlpha`,new p(r,1)),a.setAttribute(`aPhase`,new p(i,1)),a}function Te(e,t,n,i,o,s){let c=Ce(),l=xe(t),u=pe(),d=0,f=0;for(;d<l.ambient&&f<Math.max(5e3,l.ambient*35);){f++;let t=w(n,i);e===`near`&&(t.z=a.lerp(t.z,Math.abs(t.z),r.near.cameraBias*.52),t.z+=.28+x()*.58,t.length()>n&&t.setLength(n*(.76+x()*.14))),me(t,o,fe(t,s),u)&&(Se(c,t,e,`ambient`,0,0,u),d++)}for(let t=0;t<l.river;t++){let t=le(e,n);Se(c,t.p,e,`river`,t.t,t.lane,u)}for(let t=0;t<l.satellite;t++){let t=ue(e,n);Se(c,t.p,e,`satellite`,t.t,t.lane,u)}return F(c)}function Ee(){return Te(`far`,r.far.count,r.sphere.radius*.94,r.far.shellBias,0,0)}function De(){return Te(`mid`,r.mid.count,r.sphere.radius*.92,r.mid.shellBias,.67,.72)}function Oe(){return Te(`near`,r.near.count,r.sphere.radius*.9,.62,.5,-.48)}function ke(){let e=[],t=[],n=[],i=[],o=[],s=r.sphere.radius*.91,c=Math.round(r.dust.count*.16),l=Math.max(0,r.dust.count-c),u=0,d=0;for(;u<l&&d<Math.max(4e3,l*30);){d++;let c=w(s,.52);if(x()>a.clamp(.56*fe(c,.25),.18,.82))continue;let l=P(.16+x()*.56);e.push(c.x,c.y,c.z),t.push(l.r,l.g,l.b),n.push(r.dust.size*(.54+x()*1.04)),i.push(r.dust.opacity*(.24+x()*.62)),o.push(x()*Math.PI*2),u++}for(let a=0;a<c;a++){let a=le(`far`,s),c=_e(`river`,a.t,x());e.push(a.p.x,a.p.y,a.p.z),t.push(c.r,c.g,c.b),n.push(r.dust.size*(.62+x()*1.18)),i.push(r.dust.opacity*(.3+x()*.66)),o.push(x()*Math.PI*2)}return we(e,t,n,i,o)}let I={value:0};function Ae(e,t){return new c({uniforms:{uTime:I,uDrift:{value:r.motion.starDrift},uPixelRatio:{value:o.getPixelRatio()},uTwinkle:{value:r.motion.twinkle},uBrightness:{value:e},uGlow:{value:t},uAudioMid:{value:0},uAudioHigh:{value:0},uRiverLowColor:{value:y(r.colors.violet)},uRiverFlowColor:{value:y(r.colors.cyan)},uRiverHitColor:{value:y(r.colors.rim)},uAmbientLowColor:{value:y(r.colors.blue)},uAmbientHighColor:{value:y(r.colors.cyan)},uHeroColor:{value:y(r.colors.rim)},uFlowSpeed:{value:r.livingFlow.speed},uCurlStrength:{value:r.livingFlow.curlStrength},uConfinement:{value:r.livingFlow.confinement},uFlowStability:{value:r.livingFlow.stability},uFlowInfluence:{value:r.livingFlow.influence},uPulseSpeed:{value:r.livingFlow.speed*3.9},uPulseWidth:{value:r.livingFlow.pulseWidth},uPulseStrength:{value:r.livingFlow.pulseStrength},uVFXStrength:{value:r.livingFlow.vfxStrength},uTrailStrength:{value:r.livingFlow.trailStrength},uReleaseStrength:{value:r.livingFlow.releaseStrength},uVortexEvent:{value:r.livingFlow.vortexEvent},uPulsePhase:{value:0},uBeatImpulse:{value:0},uDownbeatImpulse:{value:0},uAudioSync:{value:0},uAmbientMotion:{value:0},uAmbientBeat:{value:0},uRiverPoints:{value:T}},vertexShader:`
    ...
    `,transparent:!0,depthTest:!0,depthWrite:!1,...S(),vertexColors:!0,toneMapped:!1});function Ne(e){for(let t of[...e.children])t.geometry&&t.geometry.dispose(),e.remove(t)}function Pe(){Ne(g),Ne(_),ee();let e=new t(Ee(),L),n=new t(De(),je),r=new t(Oe(),Me),i=new t(ke(),R);for(let t of[e,n,r,i])t.frustumCulled=!1;e.name=`Far Directed Field`,n.name=`Mid Directed Field`,r.name=`Near Directed Field`,i.name=`3D Dust`,g.add(e,n,r),_.add(i)}let Fe=new u(r.sphere.radius*.945,64,48),z={uTime:I,uStrength:{value:r.sphere.atmosphere},uBlue:{value:y(r.colors.blue)},uViolet:{value:y(r.colors.violet)},uAudioSection:{value:0},uAudioTrend:{value:0}},Ie=new c({uniforms:z,vertexShader:`
    ...
    `,transparent:!0,side:1,depthWrite:!1,...S(),toneMapped:!1});h.add(new e(Fe,Ie));let Le=new u(r.sphere.radius,128,96),B={uTime:I,uOpacity:{value:r.sphere.shellOpacity},uRimStrength:{value:r.sphere.rimStrength},uRimPower:{value:r.sphere.rimPower},uVariation:{value:r.sphere.edgeVariation},uRim:{value:y(r.colors.rim)},uCyan:{value:y(r.colors.cyan)},uViolet:{value:y(r.colors.violet)},uAudioMid:{value:0},uAudioHigh:{value:0},uAudioDownbeat:{value:0},uAudioColorAmount:{value:0}},Re=new c({uniforms:B,vertexShader:`
    varying vec3 vWorldPos;
    varying vec3 vWorldNormal;
    ...
    `,transparent:!0,depthWrite:!1,...S(),toneMapped:!1});v.add(new e(Le,Re)),Pe();let V={bass:0,mid:0,high:0,motion:0,brightness:0,texture:0,variation:0,relativeEnergy:.5,sectionEnergy:0,energyTrend:0,bpm:0},H={kick:0,snare:0,hihat:0,impact:0,downbeat:0},U={kick:0,snare:0,hihat:0,impact:0,downbeat:0},W=0;function ze(e,t=1){return 1-Math.exp(-Math.max(0,Number(e)||0)*t)}let G={phase:0,mix:0};function K(e,t,n,r=10,i=3.5){let a=t>e?r:i;return e+(t-e)*(1-Math.exp(-a*n))}let q={scale:1,dustScale:1,atmosphereScale:1,starTilt:0,cameraDistance:r.camera.distance},J=null,Be={},Y={state:`CALM`,previous:`CALM`,candidate:`CALM`,candidateTime:0,stateTime:0,transition:1},X={hue:.64,hueVelocity:0,colorPhase:0,chroma:.13,lightness:.6};function Ve(e,t){if(!t)return`CALM`;let n=r.colorSection,i=n.sensitivity,a=e.sectionEnergy*i,o=.5+(e.relativeEnergy-.5)*i,s=e.energyTrend*i;return a>=n.peakThreshold&&o>=n.relativeThreshold?`PEAK`:s>=n.trendThreshold&&(e.variation>=n.variationThreshold||o>.56)?`BUILD`:s<=-n.trendThreshold&&a>n.calmThreshold*.8?`RELEASE`:a<=n.calmThreshold?`CALM`:`FLOW`}function He(e,t,n){let i=Y,a=Ve(t,n);i.stateTime+=e,a===i.candidate?i.candidateTime+=e:(i.candidate=a,i.candidateTime=0);let o=r.colorSection.minHold;a!==i.state&&i.candidateTime>=o&&i.stateTime>=o*.45&&(i.previous=i.state,i.state=a,i.stateTime=0,i.transition=0);let s=Math.max(.15,r.colorSection.transitionDuration/r.colorDirector.transitionSpeed);i.transition=Math.min(1,i.transition+e/s)}function Ue(){J={blue:E(r.colors.blue),cyan:E(r.colors.cyan),violet:E(r.colors.violet),rim:E(r.colors.rim),indigo:E(`#4930ff`)}}function Z(e,t,n,r=7,i=3){let a=Be[e]||(Be[e]=t.slice());for(let e=0;e<3;e++)a[e]=K(a[e],t[e],n,r,i);return a}function Q(e,t){let n=ie(re(t,{maxValue:1.45}),{threshold:1,headroom:.28,softness:.58});e.value.set(n[0],n[1],n[2])}let $=e=>(e%1+1)%1,We=(e,t)=>((t-e+.5)%1+1)%1-.5;function Ge(e){let t=[[.98,.08+e.bass],[.64,.08+e.mid],[.38,.06+e.high]],n=0,r=0;for(let[e,i]of t)n+=Math.cos(e*Math.PI*2)*i,r+=Math.sin(e*Math.PI*2)*i;return $(Math.atan2(r,n)/(Math.PI*2))}function Ke(e,t,n){let i=X,o={CALM:.42,FLOW:.92,BUILD:1.34,PEAK:1.72,RELEASE:.68},s=Y.transition*Y.transition*(3-2*Y.transition),c=a.lerp(o[Y.previous],o[Y.state],s),l=Ge(t),u=n?(.34+t.mid*.72+t.high*1.08+t.variation*.86)*c*r.colorDirector.transitionSpeed:0;i.colorPhase=(i.colorPhase+e*u)%(Math.PI*2e3);let d=(t.high-t.bass)*.22+(t.mid-(t.bass+t.high)*.5)*.12,f=(Math.sin(i.colorPhase)*.26+Math.sin(i.colorPhase*.37+1.7)*.13)*1,p=n?$(l+f+d*1+t.texture*.1+t.variation*.16):.64,m=t.energyTrend<-.06?-1:1,h=n?m*(.012+t.mid*.045+t.high*.07+t.variation*.115+t.texture*.035)*c*1*r.colorDirector.transitionSpeed:0;i.hueVelocity=K(i.hueVelocity,h,e,4.8,2.2),i.hue=$(i.hue+i.hueVelocity*e),i.hue=$(i.hue+We(i.hue,p)*(1-Math.exp(-e*(n?1.65*r.colorDirector.transitionSpeed:.8))));let g=Math.max(0,t.relativeEnergy-.42),_=+(Y.previous===`PEAK`),v=+(Y.state===`PEAK`),y=.065*a.lerp(_,v,s)*r.colorDirector.peakAccent,b=(.135+g*.13+t.variation*.085+t.texture*.055+y)*1.15,x=.52+t.brightness*.18+t.sectionEnergy*.09;i.chroma=K(i.chroma,n?b:.13,e,4.2,2),i.lightness=K(i.lightness,n?x:.6,e,3.2,1.5)}function qe(e,t,n,i){r.colorDirector.enabled||(t=0);let o=r.colorDirector,s=a.clamp(t*o.intensity,0,1.5),c=a.clamp(o.coverage,0,1.5),l=a.clamp(s*c,0,1),u=a.clamp(n.bass,0,1)**.72,d=a.clamp(n.mid,0,1)**.72,f=a.clamp(n.high,0,1)**.68,p=a.clamp(n.sectionEnergy,0,1)**.58,m=1.12,h=X.hue,g=X.colorPhase,_=X.chroma,v=X.lightness,y=(e,t,n)=>ne([a.clamp(e,.02,.94),a.clamp(t,.01,.3),$(n)]),b=$(h+Math.sin(g*.43+n.bass*2.8)*.1*m-n.bass*.08),x=$(h+Math.sin(g*.79+1.4+n.mid*3.4)*.2*m+n.mid*.12),ee=$(h+Math.sin(g*1.37+3.1+n.high*4.2)*.31*m+n.high*.24),S=y(v-.23,_*.62,b-.035*m),C=y(v,_,b),w=y(v+.055,_*1.02,x),T=y(v+.1,_*1.16,ee),E=y(v+.22,_*.46,$(x-.18*m)),re=y(v-.17,_*.58,$(b+.11*m)),ie=y(v-.11,_*.66,$(x+.18*m)),O=o.eventIntensity*o.peakAccent,k=te([S,C,w],[.18+u,.18+d,.12+f],{preserveChroma:.78,maxChromaScale:2.2}),A=r.riverColor,j=Math.min(1,(s*c*A.response*A.coverage)**.55),ae=D(J.indigo,D(S,C,u),j),oe=D(J.cyan,D(k,w,d),j),se=Math.min(1,O*(i.kick*A.kickAccent+i.impact*A.impactAccent)),ce=D(T,E,Math.min(1,f*A.highInfluence*.42+se)),le=D(J.rim,ce,j),M=r.ambientStarColor,ue=Math.min(1,(s*c*M.response*M.coverage)**.55),de=D(J.blue,D(S,w,p),ue),fe=D(w,T,Math.min(1,M.complementary*(f+i.snare*M.snareSpread+n.variation*M.variationInfluence))),pe=D(J.cyan,fe,ue),N=r.heroColor,me=Math.min(1,N.response*O*(i.kick*N.kickAccent+i.impact*N.impactAccent+i.downbeat*N.downbeatAccent)),he=Y.transition*Y.transition*(3-2*Y.transition),ge=D(D(E,T,a.lerp(+(Y.previous===`PEAK`),+(Y.state===`PEAK`),he)*N.warmPeak*.55),y(v+.25,_*.36,ee),me*N.colorCoverage),_e=D(J.rim,ge,l),P=r.dustColor,ve=Math.min(1,(s*c*P.response*P.coverage)**.55),ye=D(J.blue,D(S,k,n.texture),ve),be=D(w,T,Math.min(1,f*P.highInfluence+n.variation*P.variationInfluence)),xe=D(J.cyan,be,ve),Se=D(T,E,Math.min(1,O*i.hihat*P.hihatAccent)),Ce=D(J.rim,Se,ve),F=r.shellColor,we=Math.min(1,(s*c*F.response*F.coverage)**.5*(1-F.basePreservation)),Te=D(D(J.rim,C,we*F.sectionInfluence),T,Math.min(1,O*i.downbeat*F.downbeatInfluence)),Ee=D(J.cyan,w,we),De=D(J.violet,T,we),Oe=r.environmentColor,ke=D(J.blue,re,Math.min(1,s*Oe.atmosphereResponse)),I=D(J.violet,ie,Math.min(1,s*Oe.atmosphereResponse)),Ae=Z(`riverLow`,ae,e,5,2.5),Ne=Z(`riverFlow`,oe,e,5,2.5),Pe=Z(`riverHit`,le,e,18,7),Fe=Z(`ambientLow`,de,e,4,1.8),Ie=Z(`ambientHigh`,pe,e,7,2.8),Le=Z(`hero`,_e,e,22,3.4);for(let[e,t]of[L,je,Me].entries()){Q(t.uniforms.uRiverLowColor,Ae),Q(t.uniforms.uRiverFlowColor,Ne),Q(t.uniforms.uRiverHitColor,Pe);let n=a.clamp(.56+(e-1)*r.ambientStarColor.depthSeparation*.34,0,1);Q(t.uniforms.uAmbientLowColor,D(Fe,Ie,n*.24)),Q(t.uniforms.uAmbientHighColor,D(Fe,Ie,n)),Q(t.uniforms.uHeroColor,Le)}Q(R.uniforms.uDustBaseColor,Z(`dustBase`,ye,e,6,3)),Q(R.uniforms.uDustSparkColor,Z(`dustSpark`,xe,e,9,4)),Q(R.uniforms.uDustHitColor,Z(`dustHit`,Ce,e,20,8)),Q(B.uRim,Z(`shellRim`,Te,e,18,2.6)),Q(B.uCyan,Z(`shellCyan`,Ee,e,1.8,.75)),Q(B.uViolet,Z(`shellViolet`,De,e,1.8,.75)),Q(z.uBlue,Z(`atmosphereBlue`,ke,e,1.5,.7)),Q(z.uViolet,Z(`atmosphereViolet`,I,e,1.5,.7))}Ue();function Je(e){if(!e)return null;let t=Number(e.energy)||0,n=Number(e.bass)||0,r=Number(e.mid)||0,i=Number(e.high)||0;return{...e,bass:n,mid:r,high:i,energy:t,motion:Number(e.motion)||0,brightness:Number(e.brightness)||t,texture:Number(e.texture??e.percussive)||0,variation:Number(e.variation)||0,relativeEnergy:Number.isFinite(Number(e.relativeEnergy))?Number(e.relativeEnergy):.5,sectionEnergy:Number(e.sectionEnergy??t)||0,energyTrend:Number(e.energyTrend)||0,bpm:Number(e.bpm)||0,kick:Number(e.kick)||0,snare:Number(e.snare)||0,hihat:Number(e.hihat)||0,impact:Number(e.impact)||Math.max(Number(e.kick)||0,Number(e.snare)||0)*.7,downbeat:Number(e.downbeat)||+!!e.isDownbeat,isDownbeat:!!e.isDownbeat}}function Ye(e){let t=r.audioReactive.enabled&&n.hasAudioData?Je(n.audioFrame):null,i=!!t;if(i)H.kick=ze(t.kick,.62),H.snare=ze(t.snare,.82),H.hihat=ze(t.hihat,1.65),H.impact=ze(t.impact,1.05),H.downbeat=ze(t.downbeat,.9),(t.isDownbeat||t.downbeat>.5)&&(G.phase=0);else for(let e of Object.keys(H))H[e]=0;let a=r.colorEnvelope,o={kick:4.6/a.kickRelease,snare:4.6/a.snareRelease,hihat:4.6/a.hihatRelease,impact:4.6/a.impactRelease,downbeat:4.6/a.downbeatRelease};for(let t of Object.keys(U))U[t]=Math.max(H[t],U[t]*Math.exp(-o[t]*e));let s=t?Number(t.bpm)||0:V.bpm;i&&s>35&&(G.phase=(G.phase+e*1.24*s/60)%1.24),G.mix=K(G.mix,i&&s>35?1:0,e,3.5,2.2);for(let n of Object.keys(V)){let r=t?Number(t[n])||0:n===`relativeEnergy`?.5:0,i=n===`sectionEnergy`?2.2:8,a=n===`sectionEnergy`?.9:3;V[n]=K(V[n],r,e,i,a)}W=K(W,+!!i,e,5,2.2),He(e,V,i),Ke(e,V,i)}function Xe(e){let t=r.audioReactive,n=V,i=U,c=(t.enabled?t.strength:0)*W,l=c*t.motion,u=c*t.brightness,f=c*t.pulse,p=c*t.ambient,g=c*t.dust,v=a.clamp(n.sectionEnergy,0,1)**.58,y=a.clamp(n.energyTrend,-1,1),b=n.bpm>35?1.24*n.bpm/60:r.livingFlow.speed*3.9,x=Math.min(1,t.tempoSync*c),ee=a.lerp(r.livingFlow.speed*3.9,b,x),S=G.mix*t.tempoSync*+(c>0),C=c*t.color;qe(e,C,n,i);for(let[e,t,o]of[[L,r.far.brightness,.36],[je,r.mid.brightness,.52],[Me,r.near.brightness,.68]])e.uniforms.uFlowSpeed.value=r.livingFlow.speed*(1+l*(n.motion*.92+n.bass*.38)),e.uniforms.uCurlStrength.value=r.livingFlow.curlStrength*(1+l*n.motion*1.15),e.uniforms.uConfinement.value=r.livingFlow.confinement*(1+l*n.bass*.32),e.uniforms.uFlowStability.value=a.clamp(r.livingFlow.stability-l*n.motion*.12,0,1),e.uniforms.uFlowInfluence.value=r.livingFlow.influence,e.uniforms.uPulseSpeed.value=ee,e.uniforms.uPulseWidth.value=r.livingFlow.pulseWidth*(1+l*n.bass*.24),e.uniforms.uPulseStrength.value=r.livingFlow.pulseStrength*(1+f*i.kick*.92),e.uniforms.uVFXStrength.value=r.livingFlow.vfxStrength*(1+l*n.motion*.72),e.uniforms.uTrailStrength.value=r.livingFlow.trailStrength*(1+l*n.motion*.36),e.uniforms.uReleaseStrength.value=r.livingFlow.releaseStrength*(1+f*i.kick*.38),e.uniforms.uVortexEvent.value=r.livingFlow.vortexEvent*(1+f*i.kick*.82),e.uniforms.uPulsePhase.value=G.phase,e.uniforms.uBeatImpulse.value=i.kick*f*.72,e.uniforms.uDownbeatImpulse.value=i.downbeat*f,e.uniforms.uAudioSync.value=a.clamp(S,0,1),e.uniforms.uAmbientMotion.value=p*n.motion,e.uniforms.uAmbientBeat.value=p*i.snare*.72,e.uniforms.uBrightness.value=t*(1+u*n.brightness*.72),e.uniforms.uGlow.value=o*(1+u*n.brightness*.48),e.uniforms.uTwinkle.value=a.clamp(r.motion.twinkle+u*n.brightness*.34,0,1.5),e.uniforms.uAudioMid.value=c*n.mid,e.uniforms.uAudioHigh.value=c*n.high;z.uStrength.value=r.sphere.atmosphere*(1+c*(v*1.18+n.brightness*.34)),z.uAudioSection.value=c*v,z.uAudioTrend.value=y,B.uOpacity.value=r.sphere.shellOpacity*(1+c*(v*.34+i.downbeat*.1)),B.uRimStrength.value=r.sphere.rimStrength*(1+c*(v*.48+n.brightness*.2+i.downbeat*.24));let w=C*r.colorDirector.intensity*r.shellColor.response*r.shellColor.coverage;B.uAudioMid.value=a.clamp(n.sectionEnergy,0,1)**.58,B.uAudioHigh.value=a.clamp(n.brightness,0,1)**.68,B.uAudioDownbeat.value=i.downbeat,B.uAudioColorAmount.value=w,R.uniforms.uAudioEnergy.value=a.clamp(g*n.high,0,1.35),R.uniforms.uAudioMotion.value=a.clamp(g*n.texture,0,1.5),R.uniforms.uAudioHigh.value=a.clamp(g*n.high**.72,0,1.4),R.uniforms.uAudioBeat.value=a.clamp(g*i.hihat,0,1.5);let T=1+c*(v*.052+Math.max(0,y)*.018);q.scale=K(q.scale,T,e,2.4,.8),m.scale.setScalar(q.scale);let E=1+c*(n.high**.72*.06+i.hihat*.055);q.dustScale=K(q.dustScale,E,e,8,3.5),_.scale.setScalar(q.dustScale);let D=1+c*(v*.026+Math.max(0,y)*.018);q.atmosphereScale=K(q.atmosphereScale,D,e,1.8,.65),h.scale.setScalar(q.atmosphereScale);let te=r.camera.distance*(1-c*v*.046-c*i.downbeat*.012);q.cameraDistance=K(q.cameraDistance,te,e,2.1,.8),s.position.setLength(q.cameraDistance),o.setClearColor(0,0),d.autoRotate=r.camera.autoOrbit>0||W>.02,d.autoRotateSpeed=r.camera.autoOrbit+c*(v*.055+Math.max(0,y)*.025)}function Ze(){for(let e of Object.keys(V))V[e]=0;V.relativeEnergy=.5;for(let e of Object.keys(H))H[e]=0;for(let e of Object.keys(U))U[e]=0;W=0,G.phase=0,G.mix=0,Y.state=`CALM`,Y.previous=`CALM`,Y.candidate=`CALM`,Y.candidateTime=0,Y.stateTime=0,Y.transition=1,Object.assign(X,{hue:.64,hueVelocity:0,colorPhase:0,chroma:.13,lightness:.6});for(let e of[L,je,Me])e.uniforms.uAudioMid.value=0,e.uniforms.uAudioHigh.value=0,e.uniforms.uPulsePhase.value=0,e.uniforms.uBeatImpulse.value=0,e.uniforms.uDownbeatImpulse.value=0,e.uniforms.uAudioSync.value=0,e.uniforms.uAmbientMotion.value=0,e.uniforms.uAmbientBeat.value=0;z.uAudioSection.value=0,z.uAudioTrend.value=0,B.uAudioMid.value=0,B.uAudioHigh.value=0,B.uAudioDownbeat.value=0,B.uAudioColorAmount.value=0,R.uniforms.uAudioEnergy.value=0,R.uniforms.uAudioMotion.value=0,R.uniforms.uAudioHigh.value=0,R.uniforms.uAudioBeat.value=0}this._core={commonTime:I,farMaterial:L,midMaterial:je,nearMaterial:Me,dustMaterial:R,atmosphereGeometry:Fe,atmosphereMaterial:Ie,atmosphereUniforms:z,shellGeometry:Le,shellMaterial:Re,shellUniforms:B,buildInterior:Pe,disposeChildren:Ne,updateAudioFeatures:Ye,applyAudioResponse:Xe,resetAudioReaction:Ze,refreshPerceptualAnchors:Ue,perceptualState:Be,visualRuntime:q,audioDrive:V,visualEvents:U,audioEvents:H,audioSync:G,colorSectionRuntime:Y,musicColorRuntime:X,approach:K,getAudioActive:()=>W}}resetGuiCamera(){if(!this.camera||!this.controls)return;let e=this.initialCameraDistance;this.camera.position.set(0,0,e),this.controls.target.set(0,0,0),this.controls.update(),this._core?.visualRuntime&&(this._core.visualRuntime.cameraDistance=e)}requestInteriorRebuild(){if(this._guiPreferencesLoading){this._pendingInteriorRebuild=!0;return}this._core?.buildInterior()}beginGuiPreferencesLoad(){this._guiPreferencesLoading=!0,this._pendingInteriorRebuild=!1}endGuiPreferencesLoad(){let e=this._pendingInteriorRebuild;this._guiPreferencesLoading=!1,this._pendingInteriorRebuild=!1,e&&this._core?.buildInterior()}setupPostProcessing(){this.renderPass=new m(this.scene,this.camera),this.composer=new h(this.renderer),this.composer.addPass(this.renderPass),this.outputPass=new g,this.composer.addPass(this.outputPass)}createGUIContainer(){this.guiContainer=b(`Animation66-gui-container`),x(`Animation66-gui-container`),document.body.appendChild(this.guiContainer)}setupGUI(){this.createGUIContainer();let e=this.params,t=this._core;this.renderer;let n=this.camera;this.controls,this.gui=new _({title:`66. Universe Sphere`,container:this.guiContainer});let r=this.gui.addFolder(`镜头与构图`);r.add(e.camera,`distance`,15,46,.01).name(`镜头距离`).onChange(e=>{t.visualRuntime.cameraDistance=e,n.position.setLength(e)}),r.add(e.sphere,`shellOpacity`,0,1.2,.001).name(`球壳透明度`).onChange(e=>t.shellUniforms.uOpacity.value=e),r.add(e.far,`count`,3e3,13e3,100).name(`星海密度`).onFinishChange(()=>this.requestInteriorRebuild()),r.add(e.composition,`riverWidth`,.7,3.2,.01).name(`河流宽度`).onFinishChange(()=>this.requestInteriorRebuild());let i=this.gui.addFolder(`基础外观`);i.add(e.sphere,`rimStrength`,0,2,.001).name(`球壳边缘`).onChange(e=>t.shellUniforms.uRimStrength.value=e),i.add(e.sphere,`atmosphere`,0,.5,.001).name(`内部大气`).onChange(e=>t.atmosphereUniforms.uStrength.value=e),i.add(e.dust,`opacity`,0,.35,.001).name(`星尘强度`).onFinishChange(()=>this.requestInteriorRebuild()),i.add(e.motion,`twinkle`,0,1,.001).name(`星光闪烁`).onChange(e=>{for(let n of[t.farMaterial,t.midMaterial,t.nearMaterial])n.uniforms.uTwinkle.value=e});let a=this.gui.addFolder(`音乐互动`);a.add(e.audioReactive,`enabled`).name(`启用音乐互动`),a.add(e.audioReactive,`strength`,0,1.5,.01).name(`整体响应`),a.add(e.audioReactive,`motion`,0,1.5,.01).name(`运动响应`),a.add(e.audioReactive,`color`,0,1.5,.01).name(`颜色响应`),a.add(e.audioReactive,`pulse`,0,1.5,.01).name(`节拍响应`);let o=this.gui.addFolder(`颜色表现`);o.add(e.colorDirector,`transitionSpeed`,.35,2.5,.01).name(`变化速度`),o.add(e.colorDirector,`peakAccent`,0,1.5,.01).name(`高潮强调`);let s=this.gui.addFolder(`高级美术`);s.add(e.livingFlow,`trailStrength`,0,1.2,.01).name(`河流亮迹`),s.add(e.livingFlow,`curlStrength`,0,1.6,.01).name(`河流卷流`),s.add(e.hero,`probability`,.002,.04,1e-4).name(`Hero 星数量`).onFinishChange(()=>this.requestInteriorRebuild()),s.add(e.near,`size`,1,8,.01).name(`主体粒子尺寸`).onFinishChange(()=>this.requestInteriorRebuild()),s.open(),this.gui.close(),this.gui.hide()}setupSettingsButton(){this.settingsButton=v(`Animation66-settings-button`),this.settingsButton.addEventListener(`click`,()=>{this.guiVisible=!this.guiVisible,this.gui&&(this.guiVisible?this.gui.show():this.gui.hide())}),document.body.appendChild(this.settingsButton)}updateWithAudioData(e,t){t!==void 0&&Number.isFinite(Number(t))&&(this.elapsed=Number(t));let n=e?.audioFeature?.animation;n?(this.audioFrame=n,this.hasAudioData=e?.isPlaying===void 0?!0:e.isPlaying===!0):(this.audioFrame=null,this.hasAudioData=!1)}updateAudioAnalysis(e){this._core&&(this._core.updateAudioFeatures(e),this._core.applyAudioResponse(e))}render(){if(this._disposed||!this._core||!this.composer)return;let e=performance.now()*.001,t=Math.min(Math.max(e-this.lastTime,1/240),.1);this.lastTime=e,this.elapsed=e-this.startTime;let n=this._core;n.commonTime.value=this.elapsed,this.updateAudioAnalysis(t);let r=n.getAudioActive(),i=(this.params.audioReactive.enabled?this.params.audioReactive.strength:0)*r,o=a.clamp(n.audioDrive.sectionEnergy,0,1)**.58;this.starsGroup.rotation.y+=(this.params.motion.rotationY*.132+i*o*.012)*t,this.starsGroup.rotation.x+=this.params.motion.rotationX*.084*t,n.visualRuntime.starTilt=n.approach(n.visualRuntime.starTilt,i*a.clamp(n.audioDrive.energyTrend,-1,1)*.045,t,1.4,.7),this.starsGroup.rotation.z=n.visualRuntime.starTilt,this.dustGroup.rotation.y-=(this.params.motion.rotationY*.06+i*(n.audioDrive.texture*.085+n.audioDrive.high*.038))*t,this.dustGroup.rotation.x+=i*(n.audioDrive.high*.052+n.visualEvents.hihat*.045)*t,this.atmosphereGroup.rotation.y-=(this.params.motion.rotationY*.027+i*o*.022)*t,this.shellGroup.rotation.y+=i*(o*.01+Math.max(0,n.audioDrive.energyTrend)*.006)*t,this.controls.update(),this.composer.render()}onWindowResize(){if(!this.camera||!this.renderer)return;let e=Math.max(1,window.innerWidth),t=Math.max(1,window.innerHeight);this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t)}dispose(){this._disposed||(this._disposed=!0,y(this.settingsButton,this.guiContainer,this.gui),this.settingsButton=null,this.guiContainer=null,this.gui=null,this.controls?.dispose(),this._core&&(this._core.disposeChildren(this.starsGroup),this._core.disposeChildren(this.dustGroup),this._core.farMaterial.dispose(),this._core.midMaterial.dispose(),this._core.nearMaterial.dispose(),this._core.dustMaterial.dispose(),this._core.atmosphereGeometry.dispose(),this._core.atmosphereMaterial.dispose(),this._core.shellGeometry.dispose(),this._core.shellMaterial.dispose()),this.composer?.dispose?.(),this.renderer?.dispose(),this.scene&&this.universe&&this.scene.remove(this.universe),this._core=null,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null)}};export{j as default};