import{Dr as e,Gt as t,Jn as n,St as r,Vt as i,Xn as a,Zn as o,g as s,l as c,r as l,u,vt as d}from"./three.module-TVF63cYk.js";import{n as f,r as p,t as m}from"./OutputPass-CxDAHfy4.js";import{a as h,i as g,n as _,r as v,t as y}from"./GUIHelper-DNd0uFVI.js";import{t as b}from"./UnrealBloomPass-C17ZlHgr.js";import{t as x}from"./OrbitControls-Ju8LL-qO.js";import{d as S,n as C,o as w,r as T}from"./PerceptualColor-DS_Cacs7.js";import{t as E}from"./GPUComputationRenderer-CvcRq-4M.js";var D=(e=!1)=>({blending:5,blendEquation:100,blendSrc:e?201:204,blendDst:201,blendEquationAlpha:100,blendSrcAlpha:e?200:201,blendDstAlpha:e?201:205,premultipliedAlpha:e}),O=e=>Object.assign(e.blendMaterial,D(!0)),k=`#4488ff`,A=C({base:k,bass:`#7c3aed`,mid:`#2563eb`,high:`#22d3ee`}),j=class{constructor(e,t={}){this.canvas=e;let n={color:k,bloomStrength:.3,bloomRadius:.15,bloomThreshold:.8,toneMappingExposure:.9,autoRotateSpeed:.2,audioSensitivity:1,bassReactivity:1,midReactivity:1,highReactivity:1,kickPulse:.65,energyBrightness:.35,colorReactivity:1.25,saturationBoost:1.6,colorLerpSpeed:.3,pointSize:.5,brightness:1,particleCount:6e4,cameraPosition:{x:0,y:10,z:50},vortexStrength:.8,flowSpeed:.1,riverWidth:30,riverHeight:20,riverLength:80,autoRotate:!1};this.settings={...n,...t},this.defaultSettings=n,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.gpuCompute=null,this.posVar=null,this.velVar=null,this.velUniforms=null,this.posUniforms=null,this.WIDTH=Math.floor(Math.sqrt(this.settings.particleCount)),this.particles=null,this.geometry=null,this.shaderMaterial=null,this.useGPUGPU=!0,this.baseHue=T(this.settings.color),this._layerColors=null,this.refreshLayerPalette(),this.a=null,this.hasAudioData=!1,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this._guiPreferencesLoading=!1,this._pendingParticleSystemRebuild=!1,this.time=0,this.lastFrameTime=0,this.kickEnvelope=0,this._riverResizeTimer=null,this.settingsButton=null,this.init()}init(){try{return this.setupThreeJS(),this.initGPGPU(),this.createParticleSystem(),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),console.log(`✅ Animation9 初始化成功`),!0}catch(e){throw console.error(`❌ Animation9 初始化失败:`,e),e}}setupThreeJS(){this.scene=new a,this.camera=new i(60,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z),this.camera.lookAt(0,0,0),this.renderer=new l({canvas:this.canvas,antialias:!0,alpha:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=this.settings.toneMappingExposure,this.renderer.outputColorSpace=n,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`,this.controls=new x(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.target.set(0,0,0),this.controls.saveState()}initGPGPU(){try{this.gpuCompute=new E(this.WIDTH,this.WIDTH,this.renderer);let e=this.gpuCompute.createTexture(),t=this.gpuCompute.createTexture(),n=e.image.data,r=t.image.data;for(let e=0;e<n.length;e+=4)n[e+0]=(Math.random()-.5)*this.settings.riverWidth,n[e+1]=(Math.random()-.5)*this.settings.riverHeight,n[e+2]=(Math.random()-.5)*this.settings.riverLength,n[e+3]=1,r[e+0]=(Math.random()-.5)*.2,r[e+1]=(Math.random()-.5)*.2,r[e+2]=(Math.random()-.5)*.2,r[e+3]=1;this.posVar=this.gpuCompute.addVariable(`texturePosition`,`
            ...
            void main() {
                ...
                `});let r=new Float32Array(this.particleCount*3),i=new Float32Array(this.particleCount*2);for(let e=0;e<this.particleCount;e++)i[e*2]=e%this.WIDTH/this.WIDTH,i[e*2+1]=Math.floor(e/this.WIDTH)/this.WIDTH,r[e*3]=0,r[e*3+1]=0,r[e*3+2]=0;this.geometry.setAttribute(`position`,new c(r,3)),this.geometry.setAttribute(`customUV`,new c(i,2)),this.particles?(this.particles.geometry=this.geometry,e?.dispose()):this.particles=new t(this.geometry,this.shaderMaterial)}catch(e){throw console.warn(`ShaderMaterial创建失败:`,e),Error(`ShaderMaterial创建失败，无法启动可视化效果`)}this.particles.parent!==this.scene&&this.scene.add(this.particles)}refreshLayerPalette(){let e=C({base:this.settings.color}).base,t=A.base;this.baseHue=T(this.settings.color);let n=this.baseHue-T(k),i=(e[0]-t[0])*.55,a=Math.max(.001,Math.hypot(t[1],t[2])),o=Math.hypot(e[1],e[2]),c=r.clamp(1+(o/a-1)*.5,.7,1.3);this._layerColors={},[`bass`,`mid`,`high`].forEach(e=>{let t=A[e],[a,o]=S(t[1],t[2],n),l=w([r.clamp(t[0]+i,.12,.9),a*c,o*c]);this._layerColors[e]=new s().setRGB(l[0],l[1],l[2],d)})}getLayerColorsFromBase(){return this._layerColors}applyBaseColorToUniforms(){if(!this.shaderMaterial)return;let e=this.getLayerColorsFromBase();this.shaderMaterial.uniforms.uBassColor.value.copy(e.bass),this.shaderMaterial.uniforms.uMidColor.value.copy(e.mid),this.shaderMaterial.uniforms.uHighColor.value.copy(e.high)}updateParticleCount(){try{let e=Math.sqrt(this.settings.particleCount);this.WIDTH=Math.floor(e),this.rebuildParticleSystem()}catch(e){console.error(`更新粒子数量失败:`,e)}}requestParticleSystemRebuild(){if(this._guiPreferencesLoading){this._pendingParticleSystemRebuild=!0;return}this.updateParticleCount()}beginGuiPreferencesLoad(){this._guiPreferencesLoading=!0}endGuiPreferencesLoad(){this._guiPreferencesLoading=!1,this._pendingParticleSystemRebuild&&(this._pendingParticleSystemRebuild=!1,this.updateParticleCount())}rebuildParticleSystem(){try{this.gpuCompute&&(this.gpuCompute.dispose(),this.gpuCompute=null,this.posVar=null,this.velVar=null,this.velUniforms=null,this.posUniforms=null),this.initGPGPU(),this.createParticleSystem(),this.gui&&this.gui.controllersRecursive().forEach(e=>{e.updateDisplay()})}catch(e){console.error(`重建粒子系统失败:`,e)}}setupPostProcessing(){let t=new f(this.scene,this.camera);this.bloomPass=new b(new e(window.innerWidth,window.innerHeight),this.settings.bloomStrength,this.settings.bloomRadius,this.settings.bloomThreshold),this.composer=new p(this.renderer),this.composer.addPass(t),this.composer.addPass(this.bloomPass),O(this.bloomPass),this.composer.addPass(new m)}setupGUI(){this.createGUIContainer(),this.gui=new h({title:`浮光星海`,container:this.guiContainer});let e=this.gui.addFolder(`视觉与粒子`);e.add(this.settings,`particleCount`,1024,1e5,1024).name(`粒子数量`).onFinishChange(()=>{this.requestParticleSystemRebuild()}),e.add(this.settings,`pointSize`,.1,5,.1).name(`粒子大小`).onChange(e=>{this.shaderMaterial&&(this.shaderMaterial.uniforms.uPointSize.value=e)}),e.add(this.settings,`brightness`,.5,5,.1).name(`粒子亮度`).onChange(e=>{this.shaderMaterial&&(this.shaderMaterial.uniforms.uBrightness.value=e)}),e.add(this.settings,`bloomStrength`,0,3,.1).name(`bloom强度`).onChange(e=>{this.bloomPass.strength=e}),e.add(this.settings,`bloomRadius`,.1,1,.05).name(`bloom半径`).onChange(e=>{this.bloomPass.radius=e}),e.add(this.settings,`bloomThreshold`,.1,1,.05).name(`bloom阈值`).onChange(e=>{this.bloomPass.threshold=e}),e.add(this.settings,`toneMappingExposure`,.1,2,.05).name(`曝光强度`).onChange(e=>{this.renderer.toneMappingExposure=e}),e.open();let t=this.gui.addFolder(`河流效果`);t.add(this.settings,`vortexStrength`,0,2,.1).name(`漩涡强度`).onChange(e=>{this.velUniforms&&(this.velUniforms.uVortexStrength.value=e)}),t.add(this.settings,`flowSpeed`,0,.5,.01).name(`流动速度`).onChange(e=>{this.velUniforms&&(this.velUniforms.uFlowSpeed.value=e)}),t.add(this.settings,`riverWidth`,10,100,1).name(`河流宽度`).onFinishChange(()=>this.requestParticleSystemRebuild()),t.add(this.settings,`riverHeight`,5,50,1).name(`河流高度`).onFinishChange(()=>this.requestParticleSystemRebuild()),t.add(this.settings,`riverLength`,20,200,1).name(`河流长度`).onChange(e=>{this.posUniforms&&(this.posUniforms.uRiverLength.value=e),this.shaderMaterial&&(this.shaderMaterial.uniforms.uRiverLength.value=e)}),t.open();let n=this.gui.addFolder(`音频交互`);n.add(this.settings,`audioSensitivity`,0,3,.1).name(`总灵敏度`),n.add(this.settings,`bassReactivity`,0,2,.05).name(`低音→漩涡`),n.add(this.settings,`midReactivity`,0,2,.05).name(`中音→横向扰动`),n.add(this.settings,`highReactivity`,0,2,.05).name(`高音→纵向扰动`),n.add(this.settings,`kickPulse`,0,1.5,.01).name(`鼓点冲击`),n.add(this.settings,`energyBrightness`,0,2,.05).name(`音量→亮度`),n.add(this.settings,`colorReactivity`,0,3,.05).name(`音频变色强度`),n.add(this.settings,`saturationBoost`,0,3,.05).name(`低频饱和增强`),n.add(this.settings,`colorLerpSpeed`,.01,1,.05).name(`变色响应速度`),n.open();let r=this.gui.addFolder(`相机控制`);r.add(this.settings,`autoRotate`).name(`自动旋转`).onChange(()=>{}),r.add(this.settings,`autoRotateSpeed`,.1,2,.1).name(`旋转速度`),this.gui.hide()}createGUIContainer(){this.guiContainer=v(`Animation9-gui-container`),y(`Animation9-gui-container`),document.body.appendChild(this.guiContainer)}setupSettingsButton(){this.settingsButton=g(`Animation9-settings-button`),this.settingsButton.addEventListener(`click`,()=>{this.guiVisible=!this.guiVisible,this.guiVisible?this.gui.show():this.gui.hide()}),document.body.appendChild(this.settingsButton)}updateAudioAnalysis(e=1/60){if(!this.hasAudioData||!this.a){this.kickEnvelope*=Math.exp(-e/.16),this.shaderMaterial&&(this.shaderMaterial.uniforms.uAudioIntensity.value=0,this.shaderMaterial.uniforms.uBassIntensity.value=0,this.shaderMaterial.uniforms.uMidIntensity.value=0,this.shaderMaterial.uniforms.uHighIntensity.value=0,this.shaderMaterial.uniforms.uPointSize.value=this.settings.pointSize,this.shaderMaterial.uniforms.uKickPulse.value=this.kickEnvelope*this.settings.kickPulse,this.shaderMaterial.uniforms.uHueShift.value=r.lerp(this.shaderMaterial.uniforms.uHueShift.value,0,1-Math.exp(-e/.18)),this.shaderMaterial.uniforms.uColorIntensity.value=r.lerp(this.shaderMaterial.uniforms.uColorIntensity.value,1,1-Math.exp(-e/.18))),this.velUniforms&&(this.velUniforms.uBass.value=0,this.velUniforms.uMid.value=0,this.velUniforms.uHigh.value=0),this.applyBaseColorToUniforms();return}let t=this.a,n=this.settings.audioSensitivity,i=Math.min(t.bass*n*this.settings.bassReactivity,1.5),a=Math.min(t.mid*n*this.settings.midReactivity,1.5),o=Math.min(t.high*n*this.settings.highReactivity,1.5);if(this.useGPUGPU&&this.velUniforms&&(this.velUniforms.uBass.value=i,this.velUniforms.uMid.value=a,this.velUniforms.uHigh.value=o),this.useGPUGPU&&this.shaderMaterial){let n=(i+a+o)/3,r=t.energy*this.settings.energyBrightness;this.shaderMaterial.uniforms.uAudioIntensity.value=Math.min(n+r,1.5),this.kickEnvelope=Math.max(t.kick,this.kickEnvelope*Math.exp(-e/.22)),this.shaderMaterial.uniforms.uKickPulse.value=this.kickEnvelope*this.settings.kickPulse,this.shaderMaterial.uniforms.uPointSize.value=this.settings.pointSize*(1+this.kickEnvelope*.12),this.updateAudioDrivenColors(i,a,o)}}updateAudioDrivenColors(e,t,n){this.shaderMaterial&&this.updateParticleLayerColors(e,t,n)}updateParticleLayerColors(e,t,n){if(!this.useGPUGPU||!this.shaderMaterial||!this.a)return;let i=this.settings.colorReactivity,a=this.settings.colorLerpSpeed,o=Math.min(1.5,t+n),s=(Math.sin(this.time*.5)*.18*o+o*.55)*i,c=1+e*this.settings.saturationBoost;this.shaderMaterial.uniforms.uHueShift.value=r.lerp(this.shaderMaterial.uniforms.uHueShift.value,s,a),this.shaderMaterial.uniforms.uColorIntensity.value=r.lerp(this.shaderMaterial.uniforms.uColorIntensity.value,c,a),this.shaderMaterial.uniforms.uBassIntensity.value=r.lerp(this.shaderMaterial.uniforms.uBassIntensity.value,e,a),this.shaderMaterial.uniforms.uMidIntensity.value=r.lerp(this.shaderMaterial.uniforms.uMidIntensity.value,t,a),this.shaderMaterial.uniforms.uHighIntensity.value=r.lerp(this.shaderMaterial.uniforms.uHighIntensity.value,n,a)}render(){try{let e=performance.now()*.001,t=this.lastFrameTime>0?Math.min(e-this.lastFrameTime,.05):1/60;if(this.lastFrameTime=e,this.time=e,this.gpuCompute&&this.posVar&&this.velVar&&(this.velUniforms&&(this.velUniforms.uTime.value=this.time),this.posUniforms&&(this.posUniforms.uTime.value=this.time),this.gpuCompute.compute(),this.shaderMaterial&&this.gpuCompute&&this.posVar)){let e=this.gpuCompute.getCurrentRenderTarget(this.posVar).texture;e&&(this.shaderMaterial.uniforms.uPosTexture.value=e,this.shaderMaterial.uniforms.uTime.value=this.time)}this.updateAudioAnalysis(t),this.controls&&(this.settings.autoRotate?(this.controls.autoRotate=!0,this.controls.autoRotateSpeed=this.settings.autoRotateSpeed):this.controls.autoRotate=!1,this.controls.update()),this.composer?this.composer.render():this.renderer&&this.scene&&this.camera&&this.renderer.render(this.scene,this.camera)}catch(e){console.error(`渲染错误:`,e)}}onWindowResize(){let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.composer.setSize(e,t)}updateWithAudioData(e,t){if(e&&e.audioFeature&&e.audioFeature.animation&&e.isPlaying!==!1){this.hasAudioData=!0;let t=e.audioFeature.animation;this.a={bass:t.bass??0,mid:t.mid??0,high:t.high??0,kick:t.kick??0,energy:t.energy??0}}else this.hasAudioData=!1,this.a=null}resetState(){this.a=null,this.hasAudioData=!1,this.kickEnvelope=0,this.velUniforms&&(this.velUniforms.uBass.value=0,this.velUniforms.uMid.value=0,this.velUniforms.uHigh.value=0),this.shaderMaterial&&(this.shaderMaterial.uniforms.uAudioIntensity.value=0,this.shaderMaterial.uniforms.uBassIntensity.value=0,this.shaderMaterial.uniforms.uMidIntensity.value=0,this.shaderMaterial.uniforms.uHighIntensity.value=0,this.shaderMaterial.uniforms.uPointSize.value=this.settings.pointSize,this.shaderMaterial.uniforms.uKickPulse.value=0,this.shaderMaterial.uniforms.uHueShift.value=0,this.shaderMaterial.uniforms.uColorIntensity.value=1),this.applyBaseColorToUniforms()}setEffectMode(e){return console.log(`当前效果模式：${e}`),!0}updateSettings(e){Object.assign(this.settings,e),e.cameraPosition&&this.camera.position.set(e.cameraPosition.x??this.settings.cameraPosition.x,e.cameraPosition.y??this.settings.cameraPosition.y,e.cameraPosition.z??this.settings.cameraPosition.z),e.bloomStrength!==void 0&&this.bloomPass&&(this.bloomPass.strength=e.bloomStrength),e.bloomRadius!==void 0&&this.bloomPass&&(this.bloomPass.radius=e.bloomRadius),e.bloomThreshold!==void 0&&this.bloomPass&&(this.bloomPass.threshold=e.bloomThreshold),e.color!==void 0&&(this.refreshLayerPalette(),this.applyBaseColorToUniforms()),e.pointSize!==void 0&&this.shaderMaterial&&(this.shaderMaterial.uniforms.uPointSize.value=e.pointSize),e.brightness!==void 0&&this.shaderMaterial&&(this.shaderMaterial.uniforms.uBrightness.value=e.brightness),e.vortexStrength!==void 0&&this.velUniforms&&(this.velUniforms.uVortexStrength.value=e.vortexStrength),e.flowSpeed!==void 0&&this.velUniforms&&(this.velUniforms.uFlowSpeed.value=e.flowSpeed),e.riverWidth!==void 0&&(this.velUniforms&&(this.velUniforms.uRiverWidth.value=e.riverWidth),this.posUniforms&&(this.posUniforms.uRiverWidth.value=e.riverWidth)),e.riverHeight!==void 0&&(this.velUniforms&&(this.velUniforms.uRiverHeight.value=e.riverHeight),this.posUniforms&&(this.posUniforms.uRiverHeight.value=e.riverHeight)),e.riverLength!==void 0&&(this.posUniforms&&(this.posUniforms.uRiverLength.value=e.riverLength),this.shaderMaterial&&(this.shaderMaterial.uniforms.uRiverLength.value=e.riverLength)),e.toneMappingExposure!==void 0&&(this.renderer.toneMappingExposure=e.toneMappingExposure),(e.particleCount!==void 0||e.riverWidth!==void 0||e.riverHeight!==void 0)&&this.updateParticleCount()}resetGuiCamera(){if(!this.camera||!this.controls)return;let e=this.defaultSettings.cameraPosition;this.camera.position.set(e.x,e.y,e.z),this.controls.target.set(0,0,0),this.controls.update()}dispose(){this._riverResizeTimer&&=(clearTimeout(this._riverResizeTimer),null),_(this.settingsButton,this.guiContainer,this.gui),this.controls&&this.controls.dispose(),this.composer&&this.composer.dispose(),this.bloomPass&&this.bloomPass.dispose(),this.particles&&this.scene.remove(this.particles),this.geometry&&this.geometry.dispose(),this.shaderMaterial&&this.shaderMaterial.dispose(),this.gpuCompute&&this.gpuCompute.dispose(),this.renderer&&this.renderer.dispose(),console.log(`✅ Animation9 资源已清理`)}getAudioDataForUI(){return{bass:this.a?this.a.bass:0,mid:this.a?this.a.mid:0,high:this.a?this.a.high:0}}playAudio(){console.log(`音频播放由系统控制`)}pauseAudio(){console.log(`音频暂停由系统控制`)}};export{j as default};