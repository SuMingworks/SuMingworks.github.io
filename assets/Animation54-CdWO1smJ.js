import{$t as e,B as t,Bt as n,Dr as r,E as i,Et as a,Gt as o,It as s,Kt as c,Mr as l,Ut as u,Vt as d,Xn as f,Zn as p,c as m,g as h,l as g,r as _,u as v,vt as y}from"./three.module-TVF63cYk.js";import{i as b,n as x,r as S,t as C}from"./OutputPass-CxDAHfy4.js";import{a as w,i as T,n as E,r as D,t as O}from"./GUIHelper-DNd0uFVI.js";import{t as k}from"./UnrealBloomPass-C17ZlHgr.js";import{t as A}from"./OrbitControls-Ju8LL-qO.js";var j=class{constructor(e,t={}){this.canvas=e,this._guiPreferencesLoading=!1,this._pendingSimulationSize=null,this.SIM_SIZE=256,this.PARTICLE_COUNT=this.SIM_SIZE*this.SIM_SIZE,this.TIME_STEP=.016,this.TRAIL_LENGTH=6,this.PRESSURE_ITERATIONS=4,this.COLOR_PRESETS=[3526655,16725718,16763972,16777215,16729190,4521864,11167487,16746564,6741503,16737962],this.COLOR_NAMES=[`青蓝`,`洋红`,`金色`,`白色`,`烈焰红`,`翡翠绿`,`紫晶`,`暖橙`,`天蓝`,`粉红`],this.INK_NAMES=[`✦ 青蓝能量`,`✦ 洋红墨水`,`✦ 金色等离子`],this.MODE_NAMES=[`✦ 无限流`,`✧ 球体`,`❋ 花朵`,`✦ 波浪`,`✦ 爆炸`];let n={simSize:256,particleSize:1,particleBrightness:.6,particleEnergy:.26,particleOpacity:.32,bloomStrength:.23,bloomRadius:.1,bloomThreshold:.5,beatExposure:.1,flowStrength:.54,fluidSpeed:.5,vorticityStrength:1.48,densityInjection:.2,densityDecay:.98,densityVolume:.15,volumeDensity:.03,volumeEnergy:.4,autoCamera:!0,vjMode:!0,vjShake:.06,cameraRadius:5.3,cameraSpeed:.5,cameraHeight:9.6,colorR:.035601,colorG:.62396,colorB:1,hue:0,audioReactive:!0,flowResponse:.6,kickInjection:.8,bassBreathe:.5,energyAtmosphere:.6,beatSensitivity:1,morphSensitivity:.5,morphFlipThreshold:.3};this.settings={...n,...t},this.defaultSettings=n,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.cinematicPass=null,this.positionRT_A=null,this.positionRT_B=null,this.velocityRT_A=null,this.velocityRT_B=null,this.densityRT_A=null,this.densityRT_B=null,this.vorticityRT=null,this.divergenceRT=null,this.pressureA=null,this.pressureB=null,this.trailTargets=[],this.gpuScene=null,this.gpuCamera=null,this.gpuQuad=null,this.vorticityMat=null,this.fluidForceMat=null,this.advectionMat=null,this.divergenceMat=null,this.pressureMat=null,this.projectionMat=null,this.densityMat=null,this.positionUpdateMat=null,this.particleMat=null,this.volumeMat=null,this.densityVolumeMat=null,this.trailCopyMat=null,this.zeroMat=null,this.particleSystem=null,this.trailSystem=null,this.volumeMesh=null,this.densityVolume=null,this.stars=null,this.targetTexture=null,this.morphValue=0,this.morphDirection=1,this.prevBeatHigh=!1,this.sculptMode=0,this.inkMode=0,this.colorPresetIdx=0,this.bass=0,this.energy=0,this.motion=0,this.kick=0,this.beat=0,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this.lastTime=0,this.frameCount=0,this.lastFpsTime=0,this.fpsDisplay=60,this.fpsSkipMode=0,this.frameSkip=0,this.initialized=!1,this.hasAudioData=!1,this._time=0,this._isReady=!1,this.inkSwitchTimer=0,this.morphSwitchTimer=0,this.colorSwitchTimer=0,this.init(),this._isReady=!0}init(){try{return this.setupThreeJS(),this.createSimulation(),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),this.initialized=!0,console.log(`✅ Animation54 初始化成功`),!0}catch(e){throw console.error(`❌ Animation54 初始化失败:`,e),e}}setupThreeJS(){this.scene=new f,this.camera=new d(60,window.innerWidth/window.innerHeight,.1,100),this.camera.position.set(-5.327,9.648,-.112),this.renderer=new _({canvas:this.canvas,antialias:!0,powerPreference:`high-performance`,alpha:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.outputColorSpace=y,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.35,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`,this.controls=new A(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.08,this.controls.target.set(0,0,0),this.controls.autoRotate=!1}setupPostProcessing(){this.composer=new S(this.renderer),this.composer.addPass(new x(this.scene,this.camera)),this.bloomPass=new k(new r(window.innerWidth,window.innerHeight),this.settings.bloomStrength,this.settings.bloomRadius,this.settings.bloomThreshold),this.composer.addPass(this.bloomPass),this.createCinematicPass(),this.composer.addPass(new C)}createCinematicPass(){let e={uniforms:{tDiffuse:{value:null},time:{value:0},aberration:{value:.002},vignette:{value:.35},bass:{value:0},beat:{value:0}},vertexShader:`
            ...
            `};this.cinematicPass=new b(e),this.composer.addPass(this.cinematicPass)}createRT(){return new l(this.SIM_SIZE,this.SIM_SIZE,{format:e,type:t,minFilter:s,magFilter:s,depthBuffer:!1,stencilBuffer:!1})}renderToTarget(e,t){this.gpuQuad.material=e,this.renderer.setRenderTarget(t),this.renderer.render(this.gpuScene,this.gpuCamera),this.renderer.setRenderTarget(null)}createSimTextures(){let n=this.SIM_SIZE*this.SIM_SIZE,r=new Float32Array(n*4),a=new Float32Array(n*4),o=new Float32Array(n*4);for(let e=0;e<n;e++){let t=Math.random()**.5*2.5,n=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1);r[e*4]=Math.sin(i)*Math.cos(n)*t,r[e*4+1]=Math.sin(i)*Math.sin(n)*t,r[e*4+2]=Math.cos(i)*t,r[e*4+3]=1,a[e*4]=(Math.random()-.5)*.02,a[e*4+1]=(Math.random()-.5)*.02,a[e*4+2]=(Math.random()-.5)*.02,a[e*4+3]=1;let s=Math.sqrt(r[e*4]*r[e*4]+r[e*4+1]*r[e*4+1]+r[e*4+2]*r[e*4+2]),c=Math.exp(-s*.5)*.5+.1;o[e*4]=c,o[e*4+1]=c*.3,o[e*4+2]=c*.8,o[e*4+3]=1}let s=new i(r,this.SIM_SIZE,this.SIM_SIZE,e,t),c=new i(a,this.SIM_SIZE,this.SIM_SIZE,e,t),l=new i(o,this.SIM_SIZE,this.SIM_SIZE,e,t);return s.needsUpdate=!0,c.needsUpdate=!0,l.needsUpdate=!0,{posTex:s,velTex:c,densTex:l}}createSimulation(){this.gpuScene=new f,this.gpuCamera=new n(-1,1,1,-1,0,1),this.gpuQuad=new a(new u(2,2)),this.gpuScene.add(this.gpuQuad),this.positionRT_A=this.createRT(),this.positionRT_B=this.createRT(),this.velocityRT_A=this.createRT(),this.velocityRT_B=this.createRT(),this.densityRT_A=this.createRT(),this.densityRT_B=this.createRT(),this.vorticityRT=this.createRT(),this.divergenceRT=this.createRT(),this.pressureA=this.createRT(),this.pressureB=this.createRT();for(let e=0;e<this.TRAIL_LENGTH;e++)this.trailTargets.push(this.createRT());this.simTex=this.createSimTextures(),this.initGPUState(),this.createShaderMaterials(),this.createPositionUpdate(),this.createTrailSystem(),this.targetTexture=this.createMorphTarget(0),this.buildParticles(),this.createVolumeAtmosphere(),this.createDensityVolume(),this.createStars()}initGPUState(){let e=new p({name:`InitCopy`,uniforms:{sourceTex:{value:null}},vertexShader:`
                varying vec2 vUv;
                void main() {
            ...
            `}),this.fluidForceMat=new p({name:`FluidForce`,uniforms:{velocityTex:{value:this.velocityRT_A.texture},vorticityTex:{value:this.vorticityRT.texture},strength:{value:.6},time:{value:0},motion:{value:0},uPixelSize:{value:e}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.advectionMat=new p({name:`Advection`,uniforms:{velocityTex:{value:this.velocityRT_A.texture},dt:{value:.016}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.divergenceMat=new p({name:`Divergence`,uniforms:{velocityTex:{value:this.velocityRT_A.texture},uPixelSize:{value:e}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.pressureMat=new p({name:`Pressure`,uniforms:{pressureTex:{value:null},divergenceTex:{value:null},uPixelSize:{value:e}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.projectionMat=new p({name:`Projection`,uniforms:{velocityTex:{value:null},pressureTex:{value:null},uPixelSize:{value:e}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.densityMat=new p({name:`Density`,uniforms:{densityTex:{value:this.densityRT_A.texture},velocityTex:{value:this.velocityRT_A.texture},time:{value:0},audio:{value:0},inkMode:{value:0},injection:{value:.003},decay:{value:.997}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.trailCopyMat=new p({name:`TrailCopy`,uniforms:{sourceTex:{value:null}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `}),this.zeroMat=new p({name:`Zero`,uniforms:{},vertexShader:`void main(){ gl_Position = vec4(position, 1.0); }`,fragmentShader:`precision highp float; void main(){ gl_FragColor = vec4(0,0,0,1); }`})}createPositionUpdate(){this.positionUpdateMat=new p({name:`PosUpdate`,uniforms:{positionTex:{value:this.positionRT_A.texture},velocityTex:{value:this.velocityRT_A.texture},delta:{value:this.TIME_STEP}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = position.xy * 0.5 + 0.5;
                    gl_Position = vec4(position, 1.0);
            ...
            `})}createMorphTarget(n){let r=new Float32Array(this.PARTICLE_COUNT*4);for(let e=0;e<this.PARTICLE_COUNT;e++){let t=e%this.SIM_SIZE/this.SIM_SIZE,i=Math.floor(e/this.SIM_SIZE)/this.SIM_SIZE,a=t*Math.PI*2,o=i*Math.PI,s,c,l;switch(n){case 0:let e=Math.random()**.5*2.5,t=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1);s=Math.sin(n)*Math.cos(t)*e,c=Math.sin(n)*Math.sin(t)*e,l=Math.cos(n)*e;break;case 1:let r=2+Math.sin(a*8)*.1;s=Math.sin(o)*Math.cos(a)*r,c=Math.cos(o)*r,l=Math.sin(o)*Math.sin(a)*r;break;case 2:let i=2*(Math.sin(a*6)*.8+1);s=Math.sin(o)*Math.cos(a)*i,c=Math.cos(o)*1.5,l=Math.sin(o)*Math.sin(a)*i;break;case 3:let u=2.5+Math.sin(a*8+o*4)*.8;s=Math.sin(o)*Math.cos(a)*u,c=Math.cos(o)*u*.8,l=Math.sin(o)*Math.sin(a)*u;break;case 4:let d=.5+Math.random()*3.5,f=Math.random()*Math.PI*2,p=Math.acos(2*Math.random()-1);s=Math.sin(p)*Math.cos(f)*d,c=Math.sin(p)*Math.sin(f)*d*.7,l=Math.cos(p)*d*.8;break;default:s=0,c=0,l=0}r[e*4]=s,r[e*4+1]=c,r[e*4+2]=l,r[e*4+3]=1}let a=new i(r,this.SIM_SIZE,this.SIM_SIZE,e,t);return a.needsUpdate=!0,a}buildParticles(){let e=new v,t=new Float32Array(this.PARTICLE_COUNT*3);for(let e=0;e<this.PARTICLE_COUNT;e++){let n=Math.random()**.5*2.5,r=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1);t[e*3]=Math.sin(i)*Math.cos(r)*n,t[e*3+1]=Math.sin(i)*Math.sin(r)*n,t[e*3+2]=Math.cos(i)*n}e.setAttribute(`position`,new g(t,3));let n=new Float32Array(this.PARTICLE_COUNT*2),r=new Float32Array(this.PARTICLE_COUNT);for(let e=0;e<this.PARTICLE_COUNT;e++)n[e*2]=e%this.SIM_SIZE/this.SIM_SIZE,n[e*2+1]=Math.floor(e/this.SIM_SIZE)/this.SIM_SIZE,r[e]=Math.random();e.setAttribute(`particleUV`,new g(n,2)),e.setAttribute(`seed`,new g(r,1)),this.particleMat=new p({name:`Particle`,transparent:!0,depthWrite:!1,blending:2,uniforms:{positionTex:{value:this.positionRT_A.texture},targetTexture:{value:this.targetTexture},morph:{value:0},time:{value:0},energy:{value:1},brightness:{value:1.5},flowColor:{value:new h(3526655)},hue:{value:0},bass:{value:0},beat:{value:0},inkMode:{value:0},sizeScale:{value:1},opacity:{value:1}},vertexShader:`
                precision highp float;
                uniform sampler2D positionTex;
            ...
            `}),this.particleSystem=new o(e,this.particleMat),this.particleSystem.frustumCulled=!1,this.scene.add(this.particleSystem)}createTrailSystem(){let e=this.PARTICLE_COUNT*this.TRAIL_LENGTH,t=new Float32Array(e*2),n=new Float32Array(e),r=0;for(let e=0;e<this.TRAIL_LENGTH;e++)for(let i=0;i<this.PARTICLE_COUNT;i++)t[r*2]=i%this.SIM_SIZE/this.SIM_SIZE,t[r*2+1]=Math.floor(i/this.SIM_SIZE)/this.SIM_SIZE,n[r]=e,r++;let i=new v;i.setAttribute(`particleUV`,new g(t,2)),i.setAttribute(`trailIndex`,new g(n,1));let a={};for(let e=0;e<this.TRAIL_LENGTH;e++)a[`history${e}`]={value:this.trailTargets[e].texture};let s=new p({name:`Trail`,transparent:!0,depthWrite:!1,blending:2,uniforms:{...a,time:{value:0},bass:{value:0}},vertexShader:`
                precision highp float;
                attribute vec2 particleUV;
...
`)}
            ...
            `});this.trailSystem=new o(i,s),this.trailSystem.frustumCulled=!1,this.scene.add(this.trailSystem)}createVolumeAtmosphere(){this.volumeMat=new p({name:`Volume`,transparent:!0,side:1,depthWrite:!1,blending:2,uniforms:{time:{value:0},density:{value:.06},energy:{value:1},morph:{value:0}},vertexShader:`
                varying vec3 vPos;
