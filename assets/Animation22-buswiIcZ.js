import{Dr as e,Gt as t,Vt as n,Xn as r,Zn as i,g as a,l as o,r as s,u as c,vt as l}from"./three.module-TVF63cYk.js";import{n as u,r as d,t as f}from"./OutputPass-CxDAHfy4.js";import{a as p,i as m,n as h,r as g,t as _}from"./GUIHelper-DNd0uFVI.js";import{t as v}from"./UnrealBloomPass-C17ZlHgr.js";import{t as y}from"./OrbitControls-Ju8LL-qO.js";var b=class{constructor(t,n={}){this.canvas=t;let r={galaxyCount:15e4,neuralCount:45e4,nebulaCount:35e4,nodeCount:25e3,galaxySize:2,nebulaSize:7,neuralSize:2,bloomStrength:.1,bloomRadius:.2,bloomThreshold:.95,nebulaOpacity:.35,autoRotationSpeed:.001,autoRotationEnabled:!1,audioBoost:6,showNodes:!0,effectMode:`full`,bassResponse:2,midResponse:1.5,trebleResponse:1,particleSizeAudio:3,colorShiftAudio:1,pulseIntensity:5,floatIntensity:5,cameraPosition:{x:0,y:0,z:12e3}};this.settings={...r,...n},this.defaultSettings=r,this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.galaxyPoints=null,this.neuralPoints=null,this.nebulaPoints=null,this.nodePoints=null,this.galaxyGeo=null,this.neuralGeo=null,this.nebulaGeo=null,this.nodeGeo=null,this.galaxyMat=null,this.neuralMat=null,this.nebulaMat=null,this.nodeMat=null,this.audioLevel=0,this.bassLevel=0,this.midLevel=0,this.trebleLevel=0,this.beatDetected=!1,this.hasAudioData=!1,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.settingsButton=null,this._guiPreferencesLoading=!1,this._guiPreferencesCounts=null,this.mouse=new e,this.onMouseMoveHandler=null,this.renderTime=0,this.init()}init(){this.setupScene(),this.setupCamera(),this.setupRenderer(),this.setupControls(),this.setupPostProcessing(),this.createGalaxy(),this.createNebula(),this.createNeuralParticles(),this.createNodes(),this.setupMouseListeners(),this.setupGUI(),this.setupSettingsButton()}setupScene(){this.scene=new r}setupCamera(){this.camera=new n(60,window.innerWidth/window.innerHeight,.1,3e4),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z)}setupRenderer(){this.renderer=new s({canvas:this.canvas,antialias:!1,alpha:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.outputColorSpace=l,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`}setupControls(){this.controls=new y(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.target.set(0,0,0)}setupPostProcessing(){let t=new u(this.scene,this.camera);this.bloomPass=new v(new e(window.innerWidth,window.innerHeight),this.settings.bloomStrength,this.settings.bloomRadius,this.settings.bloomThreshold),this.composer=new d(this.renderer),this.composer.addPass(t),this.composer.addPass(this.bloomPass),this.composer.addPass(new f)}createGalaxy(){let e=this.settings.galaxyCount;this.galaxyGeo=new c;let n=new Float32Array(e*3),r=new Float32Array(e),a=new Float32Array(e);for(let t=0;t<e;t++){let e=6e3*Math.random()**2,i=e*.005;n[t*3]=Math.cos(i)*e,n[t*3+1]=(Math.random()-.5)*1500,n[t*3+2]=Math.sin(i)*e,r[t]=e/6e3,a[t]=i}this.galaxyGeo.setAttribute(`position`,new o(n,3)),this.galaxyGeo.setAttribute(`distance`,new o(r,1)),this.galaxyGeo.setAttribute(`angle`,new o(a,1)),this.galaxyMat=new i({transparent:!0,depthWrite:!1,blending:2,uniforms:{time:{value:0},audio:{value:0},bassLevel:{value:0},midLevel:{value:0},trebleLevel:{value:0},beatDetected:{value:!1},pulseIntensity:{value:this.settings.pulseIntensity},bassResponse:{value:this.settings.bassResponse},midResponse:{value:this.settings.midResponse},trebleResponse:{value:this.settings.trebleResponse},floatIntensity:{value:this.settings.floatIntensity},particleSize:{value:this.settings.galaxySize}},vertexShader:`
            ...
            `}),this.nebulaPoints=new t(this.nebulaGeo,this.nebulaMat),this.nebulaPoints.visible=!0,this.scene.add(this.nebulaPoints)}createNeuralParticles(){let n=this.settings.neuralCount;this.neuralGeo=new c;let r=new Float32Array(n*3),s=new Float32Array(n);for(let e=0;e<n;e++)r[e*3]=(Math.random()-.5)*6e3,r[e*3+1]=(Math.random()-.5)*6e3,r[e*3+2]=(Math.random()-.5)*6e3,s[e]=Math.random()*2;this.neuralGeo.setAttribute(`position`,new o(r,3)),this.neuralGeo.setAttribute(`speed`,new o(s,1)),this.neuralMat=new i({transparent:!0,depthWrite:!1,blending:2,uniforms:{time:{value:0},audio:{value:0},mouse:{value:new e},color1:{value:new a(`#33ffaa`)},color2:{value:new a(`#ffaa33`)},audioBoost:{value:this.settings.audioBoost},bassLevel:{value:0},midLevel:{value:0},trebleLevel:{value:0},beatDetected:{value:!1},particleSizeAudio:{value:this.settings.particleSizeAudio},colorShiftAudio:{value:this.settings.colorShiftAudio},pulseIntensity:{value:this.settings.pulseIntensity},bassResponse:{value:this.settings.bassResponse},midResponse:{value:this.settings.midResponse},trebleResponse:{value:this.settings.trebleResponse},floatIntensity:{value:this.settings.floatIntensity},particleSize:{value:this.settings.neuralSize}},vertexShader:`
                attribute float speed;
                uniform float time;
                uniform float audio;
                uniform vec2 mouse;
            ...
            `}),this.neuralPoints=new t(this.neuralGeo,this.neuralMat),this.neuralPoints.visible=!0,this.scene.add(this.neuralPoints)}createNodes(){let e=this.settings.nodeCount;this.nodeGeo=new c;let n=new Float32Array(e*3),r=new Float32Array(e);for(let t=0;t<e;t++)n[t*3]=(Math.random()-.5)*5e3,n[t*3+1]=(Math.random()-.5)*5e3,n[t*3+2]=(Math.random()-.5)*5e3,r[t]=Math.random();this.nodeGeo.setAttribute(`position`,new o(n,3)),this.nodeGeo.setAttribute(`offset`,new o(r,1)),this.nodeMat=new i({transparent:!0,depthWrite:!1,blending:2,uniforms:{time:{value:0},audio:{value:0},bassLevel:{value:0},midLevel:{value:0},trebleLevel:{value:0},beatDetected:{value:!1},particleSize:{value:20}},vertexShader:`
