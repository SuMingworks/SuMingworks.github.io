import{Dr as e,Et as t,Or as n,Ut as r,Vt as i,Xn as a,Zn as o,r as s,vt as c}from"./three.module-TVF63cYk.js";import{n as l,r as u,t as d}from"./OutputPass-CxDAHfy4.js";import{a as f,i as p,n as m,r as h,t as g}from"./GUIHelper-DNd0uFVI.js";import{t as _}from"./UnrealBloomPass-C17ZlHgr.js";import{t as v}from"./OrbitControls-Ju8LL-qO.js";import{n as y}from"./PerceptualColor-DS_Cacs7.js";var b=class{constructor(e,t={}){this.canvas=e,this.colorThemes={neonRainbow:{name:`霓虹彩虹`,baseColor1:`#ff00ff`,baseColor2:`#00ffff`,accentColor:`#ffff00`,themeType:1},spectrum:{name:`七彩色谱`,baseColor1:`#ff4444`,baseColor2:`#44ff44`,accentColor:`#4444ff`,themeType:0},softRainbow:{name:`柔和彩虹`,baseColor1:`#ff88cc`,baseColor2:`#88ccff`,accentColor:`#ccff88`,themeType:2},flame:{name:`火焰光谱`,baseColor1:`#ff4400`,baseColor2:`#ff8800`,accentColor:`#ffcc00`,themeType:3},ocean:{name:`深海幽蓝`,baseColor1:`#0077b6`,baseColor2:`#00b4d8`,accentColor:`#90e0ef`,themeType:2}},this.perceptualThemePalettes={},Object.entries(this.colorThemes).forEach(([e,t])=>{this.perceptualThemePalettes[e]=y({color1:t.baseColor1,color2:t.baseColor2,color3:t.accentColor})});let n={colorTheme:`neonRainbow`,amplitude:1,detail:2,audioResponse:1.5,brightness:.5,autoRotate:!1,rotationSpeed:.5,waveSpeed:1,meshSize:30,segments:140,bloomStrength:.5,bloomRadius:.2,bloomThreshold:.6,glowIntensity:1,saturation:1,kickThreshold:.6,kickDecayRate:8,cameraPosition:{x:0,y:10,z:20}};this.settings={...n,...t},this.DEFAULTS=JSON.parse(JSON.stringify(n)),this.scene=null,this.camera=null,this.renderer=null,this.controls=null,this.composer=null,this.bloomPass=null,this.fluidMesh=null,this.fluidGeometry=null,this.fluidMaterial=null,this._guiPreferencesLoading=!1,this._pendingFluidMeshRebuild=!1,this.audioLow=0,this.audioMid=0,this.audioHigh=0,this.audioIntensity=0,this.audioFeature=null,this.hasAudioData=!1,this.isPlaying=!1,this.gui=null,this.guiContainer=null,this.guiVisible=!1,this.lastTime=0,this.time=0,this.settingsButton=null;try{this.init(),this.lastTime=performance.now()*.001}catch(e){console.error(`❌ Animation15 初始化失败:`,e)}}init(){try{return this.setupThreeJS(),this.createFluidMesh(),this.setupPostProcessing(),this.setupGUI(),this.setupSettingsButton(),console.log(`✅ Animation15 初始化成功`),!0}catch(e){throw console.error(`❌ Animation15 初始化失败:`,e),e}}setupThreeJS(){this.scene=new a,this.camera=new i(75,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(this.settings.cameraPosition.x,this.settings.cameraPosition.y,this.settings.cameraPosition.z),this.camera.lookAt(0,0,0),this.renderer=new s({canvas:this.canvas,antialias:!0,alpha:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=c,this.canvas.style.backgroundColor=`transparent`,this.canvas.style.zIndex=`1`,this.controls=new v(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.target.set(0,0,0),this.controls.autoRotate=this.settings.autoRotate,this.controls.autoRotateSpeed=this.settings.rotationSpeed,this.controls.saveState()}getThemeOklabAnchors(e){let t=this.perceptualThemePalettes[e]||this.perceptualThemePalettes.neonRainbow;return{color1:new n(...t.color1),color2:new n(...t.color2),color3:new n(...t.color3)}}createFluidMesh(){let e=new r(this.settings.meshSize,this.settings.meshSize,this.settings.segments,this.settings.segments);if(this.fluidMesh){let t=this.fluidGeometry;this.fluidGeometry=e,this.fluidMesh.geometry=e,t?.dispose();return}this.fluidGeometry=e;let n=this.colorThemes[this.settings.colorTheme]||this.colorThemes.neonRainbow,i=this.getThemeOklabAnchors(this.settings.colorTheme);this.fluidMaterial=new o({uniforms:{uTime:{value:0},uAmplitude:{value:this.settings.amplitude},uDetail:{value:this.settings.detail},uAudioResponse:{value:this.settings.audioResponse},uBrightness:{value:this.settings.brightness},uAudioLow:{value:0},uAudioMid:{value:0},uAudioHigh:{value:0},uColor1:{value:i.color1},uColor2:{value:i.color2},uColor3:{value:i.color3},uWaveSpeed:{value:this.settings.waveSpeed},uThemeType:{value:n.themeType},uAudioIntensity:{value:0},uGlowIntensity:{value:this.settings.glowIntensity},uSaturation:{value:this.settings.saturation},uBeatKick:{value:0}},vertexShader:`
                uniform float uTime;
            ...
            `,side:2,transparent:!1}),this.fluidMesh=new t(this.fluidGeometry,this.fluidMaterial),this.fluidMesh.rotation.x=-Math.PI/2.3,this.scene.add(this.fluidMesh)}setupPostProcessing(){let t=new l(this.scene,this.camera);this.bloomPass=new _(new e(window.innerWidth,window.innerHeight),this.settings.bloomStrength,this.settings.bloomRadius,this.settings.bloomThreshold),this.composer=new u(this.renderer),this.composer.addPass(t),this.composer.addPass(this.bloomPass),this.composer.addPass(new d)}setupGUI(){this.createGUIContainer(),this.gui=new f({title:`频谱流形`,container:this.guiContainer,closeFolders:!1});let e=this.gui.addFolder(`视觉设置`),t={};Object.keys(this.colorThemes).forEach(e=>{t[this.colorThemes[e].name]=e}),e.add(this.settings,`colorTheme`,t).name(`颜色主题`).onChange(e=>{this.applyColorTheme(e)}),e.add(this.settings,`amplitude`,.1,5,.1).name(`波形强度`).onChange(e=>{this.settings.amplitude=e,this.fluidMaterial&&(this.fluidMaterial.uniforms.uAmplitude.value=e)}),e.add(this.settings,`detail`,.5,4,.1).name(`波浪细节`).onChange(e=>{this.settings.detail=e,this.fluidMaterial&&(this.fluidMaterial.uniforms.uDetail.value=e)}),e.add(this.settings,`brightness`,.1,3,.05).name(`色彩亮度`).onChange(e=>{this.settings.brightness=e,this.fluidMaterial&&(this.fluidMaterial.uniforms.uBrightness.value=e)}),e.add(this.settings,`saturation`,0,3,.1).name(`色彩饱和度`).onChange(e=>{this.settings.saturation=e,this.fluidMaterial&&(this.fluidMaterial.uniforms.uSaturation.value=e)}),e.add(this.settings,`waveSpeed`,.1,3,.1).name(`波浪速度`).onChange(e=>{this.settings.waveSpeed=e,this.fluidMaterial&&(this.fluidMaterial.uniforms.uWaveSpeed.value=e)}),e.add(this.settings,`glowIntensity`,0,2,.1).name(`光晕强度`).onChange(e=>{this.fluidMaterial&&(this.fluidMaterial.uniforms.uGlowIntensity.value=e)}),e.add(this.settings,`autoRotate`).name(`自动旋转`).onChange(e=>{this.settings.autoRotate=e,this.controls.autoRotate=e}),e.add(this.settings,`rotationSpeed`,.1,2,.1).name(`旋转速度`).onChange(e=>{this.settings.rotationSpeed=e,this.controls.autoRotateSpeed=e}),e.open();let n=this.gui.addFolder(`Bloom 效果`);n.add(this.settings,`bloomStrength`,0,3,.1).name(`bloom强度`).onChange(e=>{this.settings.bloomStrength=e,this.bloomPass&&(this.bloomPass.strength=e)}),n.add(this.settings,`bloomRadius`,0,1,.05).name(`bloom半径`).onChange(e=>{this.settings.bloomRadius=e,this.bloomPass&&(this.bloomPass.radius=e)}),n.add(this.settings,`bloomThreshold`,0,1,.05).name(`bloom阈值`).onChange(e=>{this.settings.bloomThreshold=e,this.bloomPass&&(this.bloomPass.threshold=e)}),n.open();let r=this.gui.addFolder(`音频控制`);r.add(this.settings,`audioResponse`,.1,3,.1).name(`音频响应度`).onChange(e=>{this.settings.audioResponse=e,this.fluidMaterial&&(this.fluidMaterial.uniforms.uAudioResponse.value=e)}),r.add(this.settings,`kickThreshold`,.1,1.5,.05).name(`底鼓触发阈值`).onChange(e=>{this.settings.kickThreshold=e}),r.add(this.settings,`kickDecayRate`,1,20,1).name(`脉冲衰减速度`).onChange(e=>{this.settings.kickDecayRate=e}),r.open();let i=this.gui.addFolder(`网格设置`);i.add(this.settings,`meshSize`,10,50,1).name(`网格大小`).onFinishChange(e=>{this.settings.meshSize=e,this.requestFluidMeshRebuild()}),i.add(this.settings,`segments`,50,200,1).name(`网格细分`).onFinishChange(e=>{this.settings.segments=e,this.requestFluidMeshRebuild()}),i.open(),this.gui.hide()}resetParameters(){let e={...this.DEFAULTS,cameraPosition:{...this.DEFAULTS.cameraPosition}};this.updateSettings(e),this.resetState(),this.controls&&(this.controls.target.set(0,0,0),this.controls.update(),this.controls.saveState()),this.gui?.controllersRecursive().forEach(e=>e.updateDisplay())}applyColorTheme(e){(!e||!this.colorThemes[e])&&(console.warn(`主题 ${e} 不存在，使用默认主题`),e=`neonRainbow`);let t=this.colorThemes[e];if(!this.fluidMaterial)return console.error(`fluidMaterial 未初始化，无法应用主题`),!1;if(!this.fluidMaterial.uniforms.uColor1||!this.fluidMaterial.uniforms.uColor2||!this.fluidMaterial.uniforms.uColor3)return console.error(`material uniforms 不存在`),!1;try{let n=this.getThemeOklabAnchors(e);return this.fluidMaterial.uniforms.uColor1.value.copy(n.color1),this.fluidMaterial.uniforms.uColor2.value.copy(n.color2),this.fluidMaterial.uniforms.uColor3.value.copy(n.color3),this.fluidMaterial.uniforms.uThemeType.value=t.themeType,this.settings.colorTheme=e,!0}catch(e){return console.error(`❌ 应用主题失败:`,e),!1}}rebuildFluidMesh(){let e=this.settings.colorTheme;this.createFluidMesh(),this.applyColorTheme(e),this.updateAudioUniforms()}requestFluidMeshRebuild(){if(this._guiPreferencesLoading){this._pendingFluidMeshRebuild=!0;return}this.rebuildFluidMesh()}beginGuiPreferencesLoad(){this._guiPreferencesLoading=!0}endGuiPreferencesLoad(){this._guiPreferencesLoading=!1,this._pendingFluidMeshRebuild&&(this._pendingFluidMeshRebuild=!1,this.rebuildFluidMesh())}createGUIContainer(){this.guiContainer=h(`Animation15-gui-container`),g(`Animation15-gui-container`),document.body.appendChild(this.guiContainer)}setupSettingsButton(){this.settingsButton=p(`Animation15-settings-button`),this.settingsButton.addEventListener(`click`,()=>{this.guiVisible=!this.guiVisible,this.guiVisible?this.gui.show():this.gui.hide()}),document.body.appendChild(this.settingsButton)}updateAudioUniforms(){if(this.fluidMaterial){let e,t,n,r;if(this.audioFeature)e=this.audioFeature.bass,t=this.audioFeature.mid,n=this.audioFeature.high,r=this.audioFeature.energy;else{e=this.audioLow,t=this.audioMid,n=this.audioHigh,r=this.audioIntensity;let i=.35;this._smoothLow===void 0&&(this._smoothLow=e,this._smoothMid=t,this._smoothHigh=n,this._smoothIntensity=r),this._smoothLow+=(e-this._smoothLow)*i,this._smoothMid+=(t-this._smoothMid)*i,this._smoothHigh+=(n-this._smoothHigh)*i,this._smoothIntensity+=(r-this._smoothIntensity)*i,e=this._smoothLow,t=this._smoothMid,n=this._smoothHigh,r=this._smoothIntensity}this.fluidMaterial.uniforms.uAudioLow.value=e,this.fluidMaterial.uniforms.uAudioMid.value=t,this.fluidMaterial.uniforms.uAudioHigh.value=n,this.fluidMaterial.uniforms.uAudioIntensity.value=r}}render(){let e=performance.now()*.001,t=Math.min(.033,e-this.lastTime);if(this.lastTime=e,this.time+=t,this._beatKickValue===void 0?this._beatKickValue=0:(this._beatKickValue*=Math.max(0,1-t*this.settings.kickDecayRate),this._beatKickValue<.001&&(this._beatKickValue=0)),this.fluidMaterial&&(this.fluidMaterial.uniforms.uTime.value=this.time),!this.hasAudioData){this.fluidMaterial&&(this.fluidMaterial.uniforms.uAudioLow.value=0,this.fluidMaterial.uniforms.uAudioMid.value=0,this.fluidMaterial.uniforms.uAudioHigh.value=0,this.fluidMaterial.uniforms.uAudioIntensity.value=0,this.fluidMaterial.uniforms.uBeatKick.value=0),this.controls&&this.controls.update(),this.fluidMesh&&(this.fluidMesh.rotation.z=Math.sin(this.time*.02)*.1),this.composer&&this.composer.render();return}this.updateAudioUniforms(),this.fluidMaterial&&(this.fluidMaterial.uniforms.uBeatKick.value=this._beatKickValue),this.controls&&this.controls.update(),this.fluidMesh&&(this.fluidMesh.rotation.z=Math.sin(this.time*.02)*.1),this.composer&&this.composer.render()}startAnimationLoop(){this.lastTime=performance.now()*.001}onWindowResize(){if(!this.composer||!this.renderer||!this.camera)return;let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.composer.setSize(e,t)}updateWithAudioData(e,t){if(e&&e.audioFeature&&e.audioFeature.animation){this.hasAudioData=!0;let t=e.audioFeature.animation;this.audioFeature=t,this.audioLow=t.bass,this.audioMid=t.mid,this.audioHigh=t.high,this.audioIntensity=t.energy,t.kick>this.settings.kickThreshold&&(this._beatKickValue=Math.min(1,t.kick)),this._smoothLow=void 0,this.isPlaying=e.isPlaying===void 0?!0:e.isPlaying;return}if(e&&e.audioFeature?.animation){this.hasAudioData=!0,this.audioFeature=null;let t=.3;this.audioLow=this.audioLow*(1-t)+(e.audioFeature?.animation.bass||0)*t,this.audioMid=this.audioMid*(1-t)+(e.audioFeature?.animation.mid||0)*t,this.audioHigh=this.audioHigh*(1-t)+(e.audioFeature?.animation.high||0)*t,this.audioIntensity=(this.audioLow+this.audioMid+this.audioHigh)/3,e.beat&&e.beat.kick>this.settings.kickThreshold&&(this._beatKickValue=Math.min(1,e.beat.kick)),this.isPlaying=e.isPlaying===void 0?!0:e.isPlaying;return}this.hasAudioData&&(this.hasAudioData=!1,this.isPlaying=!1)}resetState(){this.audioLow=0,this.audioMid=0,this.audioHigh=0,this.audioIntensity=0,this.audioFeature=null,this.hasAudioData=!1,this.isPlaying=!1,this._beatKickValue=void 0,this._smoothLow=void 0,this._smoothMid=void 0,this._smoothHigh=void 0,this._smoothIntensity=void 0}resetGuiCamera(){if(!this.camera||!this.controls)return;let e=this.DEFAULTS.cameraPosition;this.camera.position.set(e.x,e.y,e.z),this.controls.target.set(0,0,0),this.controls.update()}setEffectMode(e){return console.log(`Animation15 当前效果模式：${e}`),!0}updateSettings(e){let t={...this.settings};Object.assign(this.settings,e),e.cameraPosition&&this.camera.position.set(e.cameraPosition.x===void 0?this.settings.cameraPosition.x:e.cameraPosition.x,e.cameraPosition.y===void 0?this.settings.cameraPosition.y:e.cameraPosition.y,e.cameraPosition.z===void 0?this.settings.cameraPosition.z:e.cameraPosition.z),e.colorTheme!==void 0&&e.colorTheme!==t.colorTheme&&(this.gui?this.gui.controllersRecursive().forEach(t=>{t.property===`colorTheme`&&(t.setValue(e.colorTheme),t.updateDisplay())}):this.applyColorTheme(e.colorTheme)),e.amplitude!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uAmplitude.value=e.amplitude),e.detail!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uDetail.value=e.detail),e.audioResponse!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uAudioResponse.value=e.audioResponse),e.brightness!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uBrightness.value=e.brightness),e.bloomStrength!==void 0&&this.bloomPass&&(this.bloomPass.strength=e.bloomStrength),e.bloomRadius!==void 0&&this.bloomPass&&(this.bloomPass.radius=e.bloomRadius),e.bloomThreshold!==void 0&&this.bloomPass&&(this.bloomPass.threshold=e.bloomThreshold),e.glowIntensity!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uGlowIntensity.value=e.glowIntensity),e.saturation!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uSaturation.value=e.saturation),e.waveSpeed!==void 0&&this.fluidMaterial&&(this.fluidMaterial.uniforms.uWaveSpeed.value=e.waveSpeed),e.autoRotate!==void 0&&this.controls&&(this.controls.autoRotate=e.autoRotate),e.rotationSpeed!==void 0&&this.controls&&(this.controls.autoRotateSpeed=e.rotationSpeed),(e.meshSize!==void 0||e.segments!==void 0)&&this.requestFluidMeshRebuild()}dispose(){if(m(this.settingsButton,this.guiContainer,this.gui),this.settingsButton=null,this.fluidMesh&&this.scene&&(this.scene.remove(this.fluidMesh),this.fluidMesh=null),this.fluidGeometry&&=(this.fluidGeometry.dispose(),null),this.fluidMaterial&&=(this.fluidMaterial.dispose(),null),this.composer&&=(this.composer.dispose(),null),this.bloomPass&&=(this.bloomPass.dispose(),null),this.renderer&&=(this.renderer.dispose(),null),this.controls&&=(this.controls.dispose(),null),this.scene){for(;this.scene.children.length>0;)this.scene.remove(this.scene.children[0]);this.scene=null}console.log(`✅ Animation15 资源已清理`)}getAudioDataForUI(){return{bass:this.audioLow,mid:this.audioMid,high:this.audioHigh,intensity:this.audioIntensity}}playAudio(){console.log(`Animation15: 音频播放由系统控制`)}pauseAudio(){console.log(`Animation15: 音频暂停由系统控制`)}getStatus(){return{settings:this.settings,audioIntensity:this.audioIntensity,time:this.time,isPlaying:this.isPlaying,currentTheme:this.colorThemes[this.settings.colorTheme]?.name||`未知`}}};export{b as default};